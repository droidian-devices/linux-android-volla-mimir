...
/*
 *  mt6789-afe-gpio.c  --  Mediatek 6789 afe gpio ctrl
 *
...
static struct audio_gpio_attr aud_gpios[MT6789_AFE_GPIO_GPIO_NUM] = {
	[MT6789_AFE_GPIO_DAT_MISO0_OFF] = {"aud_dat_miso0_off", false, NULL},
	[MT6789_AFE_GPIO_DAT_MISO0_ON] = {"aud_dat_miso0_on", false, NULL},
	[MT6789_AFE_GPIO_DAT_MISO1_OFF] = {"aud_dat_miso1_off", false, NULL},
	[MT6789_AFE_GPIO_DAT_MISO1_ON] = {"aud_dat_miso1_on", false, NULL},
	[MT6789_AFE_GPIO_DAT_MOSI_OFF] = {"aud_dat_mosi_off", false, NULL},
	[MT6789_AFE_GPIO_DAT_MOSI_ON] = {"aud_dat_mosi_on", false, NULL},
	[MT6789_AFE_GPIO_I2S0_OFF] = {"aud_gpio_i2s0_off", false, NULL},
	[MT6789_AFE_GPIO_I2S0_ON] = {"aud_gpio_i2s0_on", false, NULL},
	[MT6789_AFE_GPIO_I2S1_OFF] = {"aud_gpio_i2s1_off", false, NULL},
	[MT6789_AFE_GPIO_I2S1_ON] = {"aud_gpio_i2s1_on", false, NULL},
	[MT6789_AFE_GPIO_I2S2_OFF] = {"aud_gpio_i2s2_off", false, NULL},
	[MT6789_AFE_GPIO_I2S2_ON] = {"aud_gpio_i2s2_on", false, NULL},
	[MT6789_AFE_GPIO_I2S3_OFF] = {"aud_gpio_i2s3_off", false, NULL},
	[MT6789_AFE_GPIO_I2S3_ON] = {"aud_gpio_i2s3_on", false, NULL},
	[MT6789_AFE_GPIO_VOW_DAT_OFF] = {"vow_dat_miso_off", false, NULL},
...
EXPORT_SYMBOL(mt6789_afe_gpio_is_prepared);

static int mt6789_afe_gpio_select(struct mtk_base_afe *afe,
				  enum mt6789_afe_gpio type)
{
	int ret = 0;

	if (type >= MT6789_AFE_GPIO_GPIO_NUM) {
...
static int mt6789_afe_gpio_adda_dl(struct mtk_base_afe *afe, bool enable)
{
	if (enable)
		return mt6789_afe_gpio_select(afe,
...
static int mt6789_afe_gpio_adda_ul(struct mtk_base_afe *afe, bool enable)
{
	int ret = 0;

	if (mt6789_afe_gpio_is_prepared(MT6789_AFE_GPIO_DAT_MISO0_ON)) {
		ret = mt6789_afe_gpio_select(afe, enable ?
			    ...
			    int dai, int uplink)
{
	...
	case MT6789_DAI_ADDA:
		if (uplink)
			mt6789_afe_gpio_adda_ul(afe, enable);
		else
			mt6789_afe_gpio_adda_dl(afe, enable);
		break;
	case MT6789_DAI_I2S_0:
		if (enable)
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S0_ON);
		else
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S0_OFF);
		break;
	case MT6789_DAI_I2S_1:
		if (enable)
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S1_ON);
		else
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S1_OFF);
		break;
	case MT6789_DAI_I2S_2:
		if (enable)
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S2_ON);
		else
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S2_OFF);
		break;
	case MT6789_DAI_I2S_3:
		if (enable)
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S3_ON);
		else
			mt6789_afe_gpio_select(afe, MT6789_AFE_GPIO_I2S3_OFF);
		break;
	case MT6789_DAI_VOW:
		if (enable) {
