...
static int aw882xx_codec_probe(aw_snd_soc_codec_t *aw_codec)
{
	...
	aw_dev_info(aw882xx->dev,"aw882xx_codec_probe begin");
	...
	aw_dev_info(aw882xx->dev,"aw882xx_codec_probe end");
...
static int aw_componet_codec_register(struct aw882xx *aw882xx)
{
	...
	aw_dev_info(aw882xx->dev, "aw_componet_codec_register begin");
	...
	aw_dev_info(aw882xx->dev, "aw_componet_codec_register end");
	return 0;
}
/*****************************************************
 *
