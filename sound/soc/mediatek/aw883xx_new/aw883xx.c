...
#include "../common/mtk-sp-spk-amp.h" //add by LQ
/******************************************************
 *
 * Marco
 *
...
#define AW883XX_DRIVER_VERSION "v1.5.1"
				...
				const struct i2c_device_id *id)
{
	...
	/* hardware reset */
	if(g_aw883xx_dev_cnt == 0){//add by LQ 
	...
	mtk_spk_set_type(MTK_SPK_AWINIC_AW883XX);//add by LQ
