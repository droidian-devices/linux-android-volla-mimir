...
#define AWINIC_SMARTPA_CALI_RE   "/sys/bus/i2c/drivers/aw883xx_smartpa/6-0034/cali_re"
#define AWINIC_SMARTPA_CALI_F0    "/sys/bus/i2c/drivers/aw883xx_smartpa/6-0034/cali_f0"
...
int main(void)
{
	...
	printf("---------------------------------------\n");
	printf("aw883xx_cali_attr_example\n");
	printf("---------------------------------------\n");
