...
static const struct panel_init_cmd cm_init_cmd[] = {
	////13.8 83122	+  DSC 90Hz  1600*2560 _INIT_DCS_CMD(0xB9,0x83,0x12,0x2A,0x55,0x00),
	_INIT_DCS_CMD(0xB9,0x83,0x12,0x2A,0x55,0x00),
	_INIT_DCS_CMD(0x51,0x0F,0xFF),
	_INIT_DCS_CMD(0x53,0x24),
	_INIT_DCS_CMD(0xB1,0x10,0x31,0x31,0x2B,0xEB,0x63,0x6B,0x43,0x22,0x22,0x00,0x00,0x15,0x33,0xE1,0x40,0xCD,0xB7,0x1A,0x05,0x15,0x98,0x00,0x88,0xC4,0xCC,0xCC,0xCC,0x0F,0x88,0x52,0x00,0x00,0xD0),
	_INIT_DCS_CMD(0xE9,0xE5),
	_INIT_DCS_CMD(0xB1,0xFF,0xA0),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xB1,0x01,0x23,0x00),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xB2,0x00,0x6A,0x40,0x00,0x01,0x0C,0x02,0x00,0x6D,0x00,0x00,0x11,0x00,0x00,0x00,0x15,0x27),
	_INIT_DCS_CMD(0xB4,0x5D,0x54,0x5D,0x54,0x5D,0x54,0x5D,0x54,0x5D,0x54,0x5D,0x54,0x02,0x64,0x00,0x00,0x00,0x13,0x00,0x27,0x07,0x07,0x07,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0xFF,0x10,0x00,0x02,0x2B,0x2B,0x2B,0x2B),
	_INIT_DCS_CMD(0xB6,0x62,0x62,0x03),
	_INIT_DCS_CMD(0xE9,0xCD),
	_INIT_DCS_CMD(0xBA,0x84,0x01,0x01),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x01),
	...
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xBF,0x0A,0xB3,0x69),
	...
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xCB,0x00,0x13,0x38,0x00,0x06,0xFB),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xCB,0x1F,0x55,0x02,0x28,0x1C,0x08,0x1B),
	_INIT_DCS_CMD(0xE9,0xCB),
	_INIT_DCS_CMD(0xCB,0x0B),
	_INIT_DCS_CMD(0xE9,0xD2),
	_INIT_DCS_CMD(0xCB,0xA4),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x00),
	...
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xD2,0x00,0x00,0x00,0xB4),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xD3,0x00,0xC0,0x04,0x04,0x04,0x04,0x04,0x04,0x14,0x02,0x37,0x07,0x07,0x53,0x3F,0x0B,0x0B,0x03,0x03,0x03,0x03,0x32,0x10,0x07,0x00,0x07,0x32,0x10,0x03,0x00,0x03,0x32,0x1A,0x12,0x0A,0x12,0x00,0x00,0xFF,0x00),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xE9,0xC8),
	_INIT_DCS_CMD(0xD3,0x84,0x04),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x21,0x20,0x21,0x20,0x07,0x06,0x07,0x06,0x05,0x04,0x05,0x04,0x03,0x02,0x03,0x02,0x01,0x00,0x01,0x00,0x24,0x24,0x24,0x24,0x18,0x18,0x18,0x18,0x1E,0x1E,0x1E,0x1E,0x1F,0x1F,0x1F,0x1F,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xD6,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x21,0x20,0x21,0x20,0x07,0x06,0x07,0x06,0x05,0x04,0x05,0x04,0x03,0x02,0x03,0x02,0x01,0x00,0x01,0x00,0x24,0x24,0x24,0x24,0x18,0x18,0x18,0x18,0x1E,0x1E,0x1E,0x1E,0x1F,0x1F,0x1F,0x1F,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA,0xAA,0xAA,0xAA,0xAA,0xAA,0xFA),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xD8,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xD8,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF,0xAA,0xAF,0xFF,0xFF,0xAF,0xFF),
	_INIT_DCS_CMD(0xBD,0x03),
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xAA,0xAF,0xAA,0xAA,0xAA,0xAA,0xAA,0xAF,0xAA,0xAA,0xAA,0xAA,0xAA,0xAF,0xAA,0xAA,0xAA,0xAA,0xAA,0xAF,0xAA,0xAA),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xE0,0x00,0x0B,0x1E,0x21,0x27,0x5E,0x72,0x7C,0x80,0x83,0x84,0x86,0x84,0x84,0x85,0x82,0x82,0x85,0x86,0x9E,0xB0,0x45,0x67,0x00,0x0B,0x1E,0x21,0x27,0x5E,0x72,0x7C,0x80,0x83,0x84,0x86,0x84,0x84,0x85,0x82,0x82,0x85,0x86,0x9E,0xB0,0x45,0x67),
	...
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xE7,0x0D,0x0E,0x0E,0x1A,0x37,0x29,0x00,0x70,0x40,0x02,0x02),
	_INIT_DCS_CMD(0xE9,0xD6),
	_INIT_DCS_CMD(0xE7,0x03,0x88),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xE7,0x02,0x00,0x3A,0x01,0xCC,0x0D,0x42,0x0E,0x00,0x00),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xE7,0xFD,0x04,0xFD,0x04,0xFD,0x04,0x03,0x03,0x03,0x17,0x00,0x17,0x81,0x02,0x40,0x00,0x20,0x64,0x06,0x05,0x04,0x03,0x02,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xBB,0x00),
	_INIT_DCS_CMD(0xE9,0xD0),
	_INIT_DCS_CMD(0xBB,0x38),
	_INIT_DCS_CMD(0xE9,0x3F),
...
//add by LQ start
	...
	.dsc_params = {
		...
		.dec_delay = 657,  //556
		.scale_value = 32,
		.increment_interval = 583,  //117
		.decrement_interval = 11,   //8
		.line_bpg_offset = 12,
		.nfl_bpg_offset = 1294,  //6144
		.slice_bpg_offset = 872,  //4686
		.initial_offset = 6144,
		.final_offset = 4320,
		.flatness_minqp = 3,
		.flatness_maxqp = 12,
...
static struct mtk_panel_params ext_params_90 = {
	...
	//.vfp_low_power = 198,   //display idle Vfp
	.cust_esd_check = 0,
	.esd_check_enable = 0, // 1
	//.lcm_esd_check_table[0] = {
...
struct cust_drm_lcm m100t_hx83102e_boe_te138qdm_wqxga = {
	.name = "m100t_hx83102e_boe_te138qdm_wqxga",
