...
_INIT_DCS_CMD(0xC5,0x57),
_INIT_DCS_CMD(0x00,0x97),//VGH_I 15V
_INIT_DCS_CMD(0xC5,0x57),
_INIT_DCS_CMD(0x00,0x9E),
_INIT_DCS_CMD(0xC5,0x05), //2AVDD-AVEE(N&I)
_INIT_DCS_CMD(0x00,0x9A), //VGL_N -15V 
_INIT_DCS_CMD(0xC5,0xE1), //2AVEE-AVDD(N)
_INIT_DCS_CMD(0x00,0x9C), //VGL_I -14V
_INIT_DCS_CMD(0xC5,0xE1),//2AVEE-AVDD(I)
...
_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xD8,0xC8,0xC8), //GVDDP&NGVDD 5.5V/-5.5V
...
_INIT_DCS_CMD(0xCB,0x40),//fill Power on blank OPT
_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xE1,0x00,0x07,0x18,0x2A,0x34,0x3F,0x51,0x60,0x63,0x71,0x75,0x8C,0x75,0x60,0x5F,0x54),
_INIT_DCS_CMD(0x00,0x10),
_INIT_DCS_CMD(0xE1,0x4C,0x41,0x33,0x2D,0x28,0x1F,0x19,0x17),
_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xE2,0x00,0x07,0x18,0x2A,0x34,0x3F,0x51,0x60,0x63,0x71,0x75,0x8C,0x75,0x60,0x5F,0x54),
_INIT_DCS_CMD(0x00,0x10),
_INIT_DCS_CMD(0xE2,0x4C,0x41,0x32,0x28,0x1C,0x0B,0x08,0x08),
_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xEC,0x00,0x04,0x08,0x0C,0x29,0x10,0x15,0x18,0x1D,0x23,0x21,0x29,0x32,0x3A,0x4A),
_INIT_DCS_CMD(0x00,0x10),
_INIT_DCS_CMD(0xEC,0x41,0x4A,0x52,0x5B,0x37,0x63,0x6A,0x72,0x7A,0xFD,0x82,0x8B,0x93,0x9A,0x43),
_INIT_DCS_CMD(0x00,0x20),
_INIT_DCS_CMD(0xEC,0xA2,0xAB,0xB3,0xBC,0x52,0xC3,0xCA,0xD2,0xDA,0x20,0xE2,0xE9,0xF1,0xF9,0x18),
_INIT_DCS_CMD(0x00,0x30),
_INIT_DCS_CMD(0xEC,0xFC,0xFE,0xFF,0x05),
_INIT_DCS_CMD(0x00,0x40),
_INIT_DCS_CMD(0xEC,0x00,0x04,0x08,0x0B,0x45,0x0F,0x13,0x17,0x1A,0xC6,0x1F,0x26,0x2E,0x36,0xBC),
_INIT_DCS_CMD(0x00,0x50),
_INIT_DCS_CMD(0xEC,0x3D,0x44,0x4D,0x54,0xCA,0x5C,0x64,0x6B,0x72,0x92,0x7A,0x81,0x89,0x91,0x7D),
_INIT_DCS_CMD(0x00,0x60),
_INIT_DCS_CMD(0xEC,0x98,0xA0,0xA8,0xB0,0x95,0xB9,0xC0,0xC8,0xCF,0x8D,0xD7,0xDF,0xE7,0xF0,0x3D),
_INIT_DCS_CMD(0x00,0x70),
_INIT_DCS_CMD(0xEC,0xF3,0xF6,0xF6,0x33),
_INIT_DCS_CMD(0x00,0x80),
_INIT_DCS_CMD(0xEC,0x00,0x04,0x07,0x0B,0x31,0x0F,0x13,0x16,0x1A,0xF1,0x1F,0x27,0x2F,0x37,0xF4),
_INIT_DCS_CMD(0x00,0x90),
_INIT_DCS_CMD(0xEC,0x3E,0x47,0x4F,0x57,0x13,0x5F,0x66,0x6E,0x76,0x1D,0x7D,0x85,0x8D,0x95,0x2B),
_INIT_DCS_CMD(0x00,0xA0),
_INIT_DCS_CMD(0xEC,0x9C,0xA4,0xAC,0xB5,0x7D,0xBD,0xC5,0xCC,0xD4,0x53,0xDC,0xE4,0xEB,0xF4,0xFE),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xEC,0xF9,0xFB,0xFC,0x00),
_INIT_DCS_CMD(0x00,0x80),
_INIT_DCS_CMD(0xA4,0x2C),//Default=0x8C
...
_INIT_DCS_CMD(0x00,0xA0),
_INIT_DCS_CMD(0xCB,0xD4,0xD4,0xD4,0xD7,0xD4,0xD4,0xD4,0xD4),
...
_INIT_DCS_CMD(0xCB,0x00),
_INIT_DCS_CMD(0x00,0x80),//Left CGOUT
_INIT_DCS_CMD(0xCC,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0x88),
_INIT_DCS_CMD(0xCC,0x31,0x02,0x1C,0x2C,0x2D,0x16,0x14,0x12),
_INIT_DCS_CMD(0x00,0x90),
_INIT_DCS_CMD(0xCC,0x10,0x0E,0x0C,0x04,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0x80),//Right CGOUT
_INIT_DCS_CMD(0xCD,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0x88),
_INIT_DCS_CMD(0xCD,0x31,0x01,0x1B,0x2C,0x2D,0x15,0x13,0x11),
_INIT_DCS_CMD(0x00,0x90),
_INIT_DCS_CMD(0xCD,0x0F,0x0D,0x0B,0x03,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0xA0),//Left CGOUT
_INIT_DCS_CMD(0xCC,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0xA8),
_INIT_DCS_CMD(0xCC,0x31,0x01,0x03,0x2C,0x2D,0x13,0x15,0x0B),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xCC,0x0D,0x0F,0x11,0x1B,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0xA0),//Right CGOUT
_INIT_DCS_CMD(0xCD,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0xA8),
_INIT_DCS_CMD(0xCD,0x31,0x02,0x04,0x2C,0x2D,0x14,0x16,0x0C),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xCD,0x0E,0x10,0x12,0x1C,0x2F,0x2F),
_INIT_DCS_CMD(0x00,0x80),//STV1_ODD
_INIT_DCS_CMD(0xC2,0x85,0x03,0x00,0x96),	
_INIT_DCS_CMD(0x00,0x84),//STV1_EVEN
_INIT_DCS_CMD(0xC2,0x84,0x03,0x00,0x96),						
_INIT_DCS_CMD(0x00,0xC0),//CK1
_INIT_DCS_CMD(0xC2,0x83,0x07,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xC7),//CK2
_INIT_DCS_CMD(0xC2,0x82,0x08,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xD0),//CK3
_INIT_DCS_CMD(0xC2,0x81,0x09,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xD7),//CK4
_INIT_DCS_CMD(0xC2,0x80,0x0A,0x00,0x03,0x00,0x96,0x0B),				
_INIT_DCS_CMD(0x00,0xE0),//CK5
_INIT_DCS_CMD(0xC2,0x01,0x0B,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xE7),//CK6
_INIT_DCS_CMD(0xC2,0x02,0x0C,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xF0),//CK7
_INIT_DCS_CMD(0xC2,0x03,0x0D,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xF7),//CK8
_INIT_DCS_CMD(0xC2,0x04,0x0E,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0x80),//CK9
_INIT_DCS_CMD(0xC3,0x05,0x03,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0x87),//CK10
_INIT_DCS_CMD(0xC3,0x06,0x04,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0x90),//CK11
_INIT_DCS_CMD(0xC3,0x07,0x05,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0x97),//CK12
_INIT_DCS_CMD(0xC3,0x08,0x06,0x00,0x03,0x00,0x96,0x0B),
_INIT_DCS_CMD(0x00,0xA0),//STV2_ODD
_INIT_DCS_CMD(0xC2,0x03,0x43,0x00,0x96),	
_INIT_DCS_CMD(0x00,0xA4),//STV2_EVEN
_INIT_DCS_CMD(0xC2,0x02,0x43,0x00,0x96),	
_INIT_DCS_CMD(0x00,0xA0),//RESET_ODD
_INIT_DCS_CMD(0xC3,0x00,0x70,0xD1,0x05,0x00,0x00,0x00,0x00),	
_INIT_DCS_CMD(0x00,0xA8),//RESET_EVEN
_INIT_DCS_CMD(0xC3,0x00,0x70,0xD2,0x06,0x00,0x00,0x00,0x00),	
_INIT_DCS_CMD(0x00,0xF0),//VDD1&VDD2=1s Switch
_INIT_DCS_CMD(0xCC,0x3D,0x88,0x88,0x18,0x18,0x80),
_INIT_DCS_CMD(0x00,0xA2),
_INIT_DCS_CMD(0xF3,0x55),//ECLK12&(~GOFF12)
_INIT_DCS_CMD(0x00,0xE0),//GOFF1_LH
_INIT_DCS_CMD(0xC3,0x27,0x00,0x00,0x00),	
_INIT_DCS_CMD(0x00,0xE4),//GOFF2_LH
_INIT_DCS_CMD(0xC3,0x27,0x00,0x00,0x00),
_INIT_DCS_CMD(0x00,0xEC),
_INIT_DCS_CMD(0xC3,0xC2,0xC2),
_INIT_DCS_CMD(0x00,0xF0),
_INIT_DCS_CMD(0xC3,0x36,0x00,0x00,0x00),
_INIT_DCS_CMD(0x00,0xF4),
_INIT_DCS_CMD(0xC3,0x36,0x00,0x00,0x00),
_INIT_DCS_CMD(0x00,0x80),
_INIT_DCS_CMD(0xC0,0x00,0x91,0x00,0xE8,0x00,0x10),
_INIT_DCS_CMD(0x00,0x90),
_INIT_DCS_CMD(0xC0,0x00,0x91,0x00,0xE8,0x00,0x10),
_INIT_DCS_CMD(0x00,0xA0),
_INIT_DCS_CMD(0xC0,0x00,0xFA,0x00,0xE8,0x00,0x10),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xC0,0x00,0xA7,0x00,0xE8,0x10),
_INIT_DCS_CMD(0x00,0xA3),
_INIT_DCS_CMD(0xC1,0x00,0x0F,0x00,0x0F,0x00,0x04),
_INIT_DCS_CMD(0x00,0x80),
_INIT_DCS_CMD(0xCE,0x01,0x81,0x09,0x21,0x00,0x15,0x00,0xD6,0x00,0x2A,0x00,0x3A),
_INIT_DCS_CMD(0x00,0x90),
_INIT_DCS_CMD(0xCE,0x00,0x88,0x0C,0x93,0x00,0x44,0x80,0x09,0x21,0x00,0x03,0x00,0x22,0x0C),
_INIT_DCS_CMD(0x00,0xA0),
_INIT_DCS_CMD(0xCE,0x10,0x00,0x46),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xCE,0x62,0x00,0x00),
_INIT_DCS_CMD(0x00,0xCC),
_INIT_DCS_CMD(0xCE,0x07,0xFD),
_INIT_DCS_CMD(0x00,0xD0),
_INIT_DCS_CMD(0xCE,0x01,0x00,0x0B,0x01,0x01,0x00,0xE2,0x01),
_INIT_DCS_CMD(0x00,0xE1),
_INIT_DCS_CMD(0xCE,0x08,0x01,0x6B,0x02,0x37,0x00,0x84),
_INIT_DCS_CMD(0x00,0xF0),
_INIT_DCS_CMD(0xCE,0x00,0x12,0x09,0x00,0xC2,0x00,0xC2,0x00,0xF8,0x1D),
_INIT_DCS_CMD(0x00,0xB0),
_INIT_DCS_CMD(0xCF,0x07,0x07,0xD6,0xDA),
_INIT_DCS_CMD(0x00,0xB5),
_INIT_DCS_CMD(0xCF,0x03,0x03,0xA6,0xAA),
_INIT_DCS_CMD(0x00,0xC0),
_INIT_DCS_CMD(0xCF,0x07,0x07,0xEE,0xF2),
...
_INIT_DCS_CMD(0x00,0xA2),	
_INIT_DCS_CMD(0xF5,0x1F),	//Source PL
...
_INIT_DCS_CMD(0x00,0xB6),
_INIT_DCS_CMD(0xC5,0x41,0x41),  //VGHO1_N_I 13.8V
_INIT_DCS_CMD(0x00,0xB8),
_INIT_DCS_CMD(0xC5,0x55,0x55), //VGLO1_N_I -13.8V
_INIT_DCS_CMD(0x00,0x9A),	     //vcom_en
_INIT_DCS_CMD(0xF5,0x00),	
_INIT_DCS_CMD(0x00,0xB2),      //slave PosDmy RTN
_INIT_DCS_CMD(0xCE,0x95),
_INIT_DCS_CMD(0x00,0x00),	
_INIT_DCS_CMD(0xFA,0x5A),	
_INIT_DCS_CMD(0x00,0x88),
...
struct cust_drm_lcm m100t_ft8205_sq104aq7e1511_pen_wuxga2000 = {
	.name = "m100t_ft8205_sq104aq7e1511_pen_wuxga2000",
