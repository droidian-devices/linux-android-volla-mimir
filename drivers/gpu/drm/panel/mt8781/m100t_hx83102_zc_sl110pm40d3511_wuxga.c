...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0xB1,0x2C,0xAB,0xAB,0x27,0xE7,0x32,0xCD,0x43,0x36,0x36,0x36,0x36,0x32,0x8B,0x11,0x65,0x00,0x88,0xFA,0xFF,0xFF,0x8F,0xFF,0x08,0x9A,0x33),
	_INIT_DCS_CMD(0xB2,0x00,0x47,0xB0,0x80,0x00,0x12,0x71,0x3C,0xA3,0x00,0x00,0x00,0x00,0x88,0xF5),
	_INIT_DCS_CMD(0xB4,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x5A,0x58,0x4C,0x01,0x9B,0x01,0x00,0x03,0x05,0x03),
	_INIT_DCS_CMD(0xE0,0x00,0x02,0x0B,0x13,0x1A,0x2A,0x43,0x47,0x4C,0x48,0x5F,0x64,0x69,0x76,0x74,0x7C,0x85,0x98,0x99,0x4C,0x55,0x61,0x73,0x00,0x02,0x0B,0x13,0x1A,0x2A,0x43,0x47,0x4C,0x48,0x5F,0x64,0x69,0x76,0x74,0x7C,0x85,0x98,0x99,0x4C,0x55,0x61,0x73),
	_INIT_DCS_CMD(0xE9,0xCD),
	_INIT_DCS_CMD(0xBA,0x84),
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBC,0x1B,0x04),
	_INIT_DCS_CMD(0xBE,0x20),
	_INIT_DCS_CMD(0xBF,0xFC,0xC4,0x80,0x9C,0x36,0x00,0x0D,0x04),
	_INIT_DCS_CMD(0xC0,0x34,0x34,0x22,0x11,0x22,0xA0,0x61,0x08,0xF5,0x03),
	_INIT_DCS_CMD(0xC2,0x43,0xFF,0x00),
	...
	_INIT_DCS_CMD(0xD3,0x06,0x00,0x00,0x00,0x00,0x08,0x08,0x08,0x08,0x37,0x47,0x74,0x37,0x10,0x10,0x03,0x03,0x32,0x10,0x0B,0x00,0x0B,0x32,0x17,0x9A,0x07,0x9A,0x32,0x10,0x08,0x00,0x08,0x00,0x00),
	_INIT_DCS_CMD(0xD5,0x25,0x25,0x24,0x24,0x19,0x19,0x18,0x18,0x18,0x18,0x1E,0x1E,0x1F,0x1F,0x18,0x18,0x00,0x00,0x01,0x01,0x02,0x02,0x03,0x03,0x04,0x04,0x05,0x05,0x06,0x06,0x07,0x07,0x21,0x21,0x20,0x20,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xD6,0x20,0x20,0x21,0x21,0x18,0x18,0x19,0x19,0x18,0x18,0x1E,0x1E,0x1F,0x1F,0x40,0x40,0x07,0x07,0x06,0x06,0x05,0x05,0x04,0x04,0x03,0x03,0x02,0x02,0x01,0x01,0x00,0x00,0x24,0x24,0x25,0x25,0x40,0x40,0x18,0x18,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xD8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0xE1,0x11,0x00,0x00,0x89,0x30,0x80,0x07,0x80,0x02,0x58,0x00,0x28,0x02,0x58,0x02,0x58,0x02,0x00,0x02,0x2C,0x00,0x20,0x04,0x12,0x00,0x08,0x00,0x0C,0x02,0x77,0x02,0x4A,0x18,0x00,0x10,0xF0,0x03,0x0C,0x20,0x00,0x06,0x0B,0x0B,0x33,0x0E),
	_INIT_DCS_CMD(0xE7,0x19,0x10,0x10,0x2C,0x34,0x9C,0x02,0x4C,0xA9,0x14,0x14,0x00,0x00,0x00,0x00,0xF0,0x07,0x01,0x02,0x00,0x33,0x03,0x84,0x18,0x01),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xB1,0x01,0x7F,0x11,0xFD),
	_INIT_DCS_CMD(0xCB,0x86),
	_INIT_DCS_CMD(0xE9,0xC5),
	_INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x80,0x80,0x0C,0x81),
	_INIT_DCS_CMD(0xE9,0x3F),
	...
	_INIT_DCS_CMD(0xE7,0x02,0x00,0x2B,0x01,0x7E,0x0F,0x7E,0x10,0xA0,0x00,0x04),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xCB,0x03,0x07,0x00,0x10,0x79),
	_INIT_DCS_CMD(0xBF,0xF2),
	_INIT_DCS_CMD(0xD8,0xFF,0xFE,0xFF,0xFF,0xFA,0xB0,0xFF,0xFE,0xFF,0xFF,0xFA,0xB0),
	_INIT_DCS_CMD(0xE7,0xFE,0x02,0xFE,0x02,0xFE,0x02,0x01,0x01,0x01,0x24,0x00,0x24,0x81,0x02,0x40,0x00,0x20,0x9B,0x05,0x04,0x03,0x02,0x01,0x00,0x00,0x00,0x01,0x00),
	_INIT_DCS_CMD(0xBD,0x03),
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xFF,0xFE,0xFF,0xFF,0xFA,0xB0,0xFF,0xFE,0xFF,0xFF,0xFA,0xB0),
	...
	_INIT_DCS_CMD(0xE9,0x3F),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xBE,0x01,0x96),
	_INIT_DCS_CMD(0xD9,0x3F,0x3F),
...
struct cust_drm_lcm m100t_hx83102_zc_sl110pm40d3511_wuxga = {
	.name = "m100t_hx83102_zc_sl110pm40d3511_wuxga",
