...
#if IS_ENABLED(CONFIG_CM_MIDMISC_SUPPORT)
static void lcm_resume_cmd(struct common_panel *cm){
	struct mipi_dsi_device *dsi = cm->dsi;

	mipi_dsi_dcs_write(dsi, 0x11, 0x00, 1);
	mdelay(20);
	mipi_dsi_dcs_write(dsi, 0x29, 0x00, 1);
	mdelay(20);
}
#endif
...
struct cust_drm_lcm m100t_hx83102e_boe_tv084wum_lw0_wuxga = {
	.name = "m100t_hx83102e_boe_tv084wum_lw0_wuxga",
