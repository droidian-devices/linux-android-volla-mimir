...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	//Set B2
	_INIT_DCS_CMD(0xB2,0x00,0xB0,0x47,0x80,0x00,0x2C,0xE0,0x29,0x11,0x11,0x00,0x00,0x15,0x20,0xD7,0x00),
	//Set B4
	_INIT_DCS_CMD(0xB4,0x88,0x64,0x01,0x01,0x88,0x64,0x88,0x64,0x01,0x98,0x01),
	//Set BA
	...
	//Set CB
	_INIT_DCS_CMD(0xCB,0x00,0x13,0x08,0x02,0x24),
	//Set CC
	_INIT_DCS_CMD(0xCC,0x02),
	//Set D0
	_INIT_DCS_CMD(0xD0,0x07,0x04,0x05),
	//Set D3
	_INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x00,0x3C,0x04,0x00,0x00,0x00,0x4B,0x40,0xA4,0x4F,0x2B,0x2B,0x04,0x04,0x32,0x10,0x25,0x00,0x25,0x32,0x17,0xAB,0x07,0xAB,0x32,0x17,0xB0,0x07,0xB0,0x00,0x00,0x21,0x38,0x01,0x55,0x21,0x38,0x01,0x55,0x0F),
	//Set GIP
	...
	//Set D8
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xEA,0xAA,0xAA,0xA0,0xAA,0xAA,0xEA,0xAA,0xAA,0xA0),
	//Set Gamma
	_INIT_DCS_CMD(0xE0,0x00 ,0x02 ,0x07 ,0x0B ,0x10 ,0x13 ,0x27 ,0x2D ,0x35 ,0x33 ,0x51 ,0x5B ,0x66 ,0x7B ,0x7D ,0x8A ,0x95 ,0xAA ,0xAB ,0x55 ,0x5C ,0x63 ,0x65 ,0x00 ,0x02 ,0x07 ,0x0B ,0x10 ,0x13 ,0x27 ,0x2D ,0x35 ,0x33 ,0x51 ,0x5B ,0x66 ,0x7B ,0x7D ,0x8A ,0x95 ,0xAA ,0xAB ,0x55 ,0x5C ,0x68 ,0x73),
	//Set E7
	_INIT_DCS_CMD(0xE7,0x12,0x13,0x02,0x02),
	//Set BD
	...
	//Set CB
	_INIT_DCS_CMD(0xCB,0x00,0x03,0x00,0x01,0x7D),
	//Set D8
	_INIT_DCS_CMD(0xD8,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0),
	//Set BD
	_INIT_DCS_CMD(0xBD,0x03),
	//Set D8
	_INIT_DCS_CMD(0xD8,0xAA,0xAB,0xEA,0xAA,0xAA,0xA0,0xAA,0xAB,0xEA,0xAA,0xAA,0xA0,0xAA,0xAF,0xFF,0xFF,0xFE,0xA0,0xAA,0xAF,0xFF,0xFF,0xFE,0xA0),
	//Set BD
...
struct cust_drm_lcm m100t_hx83102e_sat111at51m0014_wuxga = {
	.name = "m100t_hx83102e_sat111at51m0014_wuxga",
