...
static int common_panel_unprepare_power(struct drm_panel *panel)
{
	...
	pr_notice("ty--->[Kernel/LCM] %s enter\n", __func__);
    ...
    mdelay(5);
#endif
	pr_notice("ty--->for delay 115 ms in!!!\n");
	mdelay(115);
	pr_notice("ty--->for delay 115 ms out!!!\n");
...
struct cust_drm_lcm m100t_it6112_ts137xumlw0d8p0_wuxga2176 = {
	.name = "m100t_it6112_ts137xumlw0d8p0_wuxga2176",
