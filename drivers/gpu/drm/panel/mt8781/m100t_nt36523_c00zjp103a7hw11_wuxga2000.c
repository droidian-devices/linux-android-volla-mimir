...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DELAY_CMD(10),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0xB0,0x00,0x48,0x00,0x59,0x00,0x77,0x00,0x90,0x00,0xA7,0x00,0xBA,0x00,0xCD,0x00,0xDC),
    _INIT_DCS_CMD(0xB1,0x00,0xEC,0x01,0x1E,0x01,0x43,0x01,0x7F,0x01,0xAA,0x01,0xEE,0x02,0x1F,0x02,0x21),
    _INIT_DCS_CMD(0xB2,0x02,0x54,0x02,0x90,0x02,0xC2,0x02,0xFA,0x03,0x25,0x03,0x55,0x03,0x67,0x03,0x77),
    _INIT_DCS_CMD(0xB3,0x03,0x8B,0x03,0x9F,0x03,0xB5,0x03,0xC9,0x03,0xD5,0x03,0xD6),
    _INIT_DCS_CMD(0xB4,0x00,0x48,0x00,0x59,0x00,0x77,0x00,0x90,0x00,0xA7,0x00,0xBA,0x00,0xCD,0x00,0xDC),
    _INIT_DCS_CMD(0xB5,0x00,0xEC,0x01,0x1E,0x01,0x43,0x01,0x7F,0x01,0xAA,0x01,0xEE,0x02,0x1F,0x02,0x21),
    _INIT_DCS_CMD(0xB6,0x02,0x54,0x02,0x90,0x02,0xC2,0x02,0xFA,0x03,0x25,0x03,0x55,0x03,0x67,0x03,0x77),
    _INIT_DCS_CMD(0xB7,0x03,0x8B,0x03,0x9F,0x03,0xB5,0x03,0xC9,0x03,0xD5,0x03,0xD6),
    _INIT_DCS_CMD(0xB8,0x00,0x48,0x00,0x59,0x00,0x77,0x00,0x90,0x00,0xA7,0x00,0xBA,0x00,0xCD,0x00,0xDC),
    _INIT_DCS_CMD(0xB9,0x00,0xEC,0x01,0x1E,0x01,0x43,0x01,0x7F,0x01,0xAA,0x01,0xEE,0x02,0x1F,0x02,0x21),
    _INIT_DCS_CMD(0xBA,0x02,0x54,0x02,0x90,0x02,0xC2,0x02,0xFA,0x03,0x25,0x03,0x55,0x03,0x67,0x03,0x77),
    _INIT_DCS_CMD(0xBB,0x03,0x8B,0x03,0x9F,0x03,0xB5,0x03,0xC9,0x03,0xD5,0x03,0xD6),
    _INIT_DCS_CMD(0xC6,0x11),
    _INIT_DCS_CMD(0xC7,0x11),
    _INIT_DCS_CMD(0xC8,0x11),
    _INIT_DCS_CMD(0xC9,0x11),
    _INIT_DCS_CMD(0xCA,0x11),
    _INIT_DCS_CMD(0xCB,0x11),
    _INIT_DCS_CMD(0xCC,0x11),
    _INIT_DCS_CMD(0xCD,0x11),
    _INIT_DCS_CMD(0xCE,0x11),
    _INIT_DCS_CMD(0xCF,0x11),
    _INIT_DCS_CMD(0xD0,0x11),
    _INIT_DCS_CMD(0xD1,0x11),
    _INIT_DCS_CMD(0xD2,0x11),
    _INIT_DCS_CMD(0xD3,0x11),
    _INIT_DCS_CMD(0xD4,0x11),
    _INIT_DCS_CMD(0xD5,0x11),
    _INIT_DCS_CMD(0xD6,0x11),
    _INIT_DCS_CMD(0xD7,0x11),
    _INIT_DCS_CMD(0xD8,0x11),
    _INIT_DCS_CMD(0xD9,0x11),
    _INIT_DCS_CMD(0xDA,0x11),
    _INIT_DCS_CMD(0xDB,0x11),
    _INIT_DCS_CMD(0xDC,0x11),
    _INIT_DCS_CMD(0xDD,0x11),
    _INIT_DCS_CMD(0xDE,0x11),
    _INIT_DCS_CMD(0xDF,0x11),
    _INIT_DCS_CMD(0xE0,0x11),
    _INIT_DCS_CMD(0xE1,0x11),
    _INIT_DCS_CMD(0xE2,0x11),
    _INIT_DCS_CMD(0xE3,0x11),
    _INIT_DCS_CMD(0xFF,0x21),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0xB0,0x00,0x40,0x00,0x51,0x00,0x6F,0x00,0x88,0x00,0x9F,0x00,0xB2,0x00,0xC5,0x00,0xD4),
    _INIT_DCS_CMD(0xB1,0x00,0xE4,0x01,0x16,0x01,0x3B,0x01,0x77,0x01,0xA2,0x01,0xE6,0x02,0x17,0x02,0x19),
    _INIT_DCS_CMD(0xB2,0x02,0x4C,0x02,0x88,0x02,0xBA,0x02,0xF2,0x03,0x1D,0x03,0x4D,0x03,0x5F,0x03,0x6F),
    _INIT_DCS_CMD(0xB3,0x03,0x83,0x03,0x97,0x03,0xAD,0x03,0xC1,0x03,0xCD,0x03,0xCE),
    _INIT_DCS_CMD(0xB4,0x00,0x40,0x00,0x51,0x00,0x6F,0x00,0x88,0x00,0x9F,0x00,0xB2,0x00,0xC5,0x00,0xD4),
    _INIT_DCS_CMD(0xB5,0x00,0xE4,0x01,0x16,0x01,0x3B,0x01,0x77,0x01,0xA2,0x01,0xE6,0x02,0x17,0x02,0x19),
    _INIT_DCS_CMD(0xB6,0x02,0x4C,0x02,0x88,0x02,0xBA,0x02,0xF2,0x03,0x1D,0x03,0x4D,0x03,0x5F,0x03,0x6F),
    _INIT_DCS_CMD(0xB7,0x03,0x83,0x03,0x97,0x03,0xAD,0x03,0xC1,0x03,0xCD,0x03,0xCE),
    _INIT_DCS_CMD(0xB8,0x00,0x40,0x00,0x51,0x00,0x6F,0x00,0x88,0x00,0x9F,0x00,0xB2,0x00,0xC5,0x00,0xD4),
    _INIT_DCS_CMD(0xB9,0x00,0xE4,0x01,0x16,0x01,0x3B,0x01,0x77,0x01,0xA2,0x01,0xE6,0x02,0x17,0x02,0x19),
    _INIT_DCS_CMD(0xBA,0x02,0x4C,0x02,0x88,0x02,0xBA,0x02,0xF2,0x03,0x1D,0x03,0x4D,0x03,0x5F,0x03,0x6F),
    _INIT_DCS_CMD(0xBB,0x03,0x83,0x03,0x97,0x03,0xAD,0x03,0xC1,0x03,0xCD,0x03,0xCE),
    ...
    _INIT_DCS_CMD(0x36,0x03), //rotation  180:0x00    0:0x03
...
struct cust_drm_lcm m100t_nt36523_c00zjp103a7hw11_wuxga2000 = {
	.name = "m100t_nt36523_c00zjp103a7hw11_wuxga2000",
