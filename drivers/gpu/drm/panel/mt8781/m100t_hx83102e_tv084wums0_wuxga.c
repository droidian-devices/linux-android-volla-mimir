...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DCS_CMD(0xC9,0x04,0x5D,0xC0),
    _INIT_DCS_CMD(0xCE,0x00,0x50,0xF0),
    _INIT_DCS_CMD(0xD2,0x29,0x29),
    _INIT_DCS_CMD(0xD9,0x00,0x01,0x02),
    _INIT_DCS_CMD(0xD5,0x03,0x02,0x03,0x02,0x18,0x18,0x18,0x18,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x24,0x24,0x24,0x24,0x18,0x18,0x18,0x18,0x01,0x00,0x01,0x00,0x07,0x06,0x07,0x06,0x05,0x04,0x05,0x04,0x21,0x20,0x21,0x20,0x23,0x22,0x23,0x22),
    _INIT_DCS_CMD(0xD6,0x04,0x05,0x04,0x05,0x18,0x18,0x18,0x18,0x19,0x19,0x19,0x19,0x18,0x18,0x18,0x18,0x24,0x24,0x24,0x24,0x19,0x19,0x19,0x19,0x06,0x07,0x06,0x07,0x00,0x01,0x00,0x01,0x02,0x03,0x02,0x03,0x22,0x23,0x22,0x23,0x20,0x21,0x20,0x21),
    _INIT_DCS_CMD(0xB4,0x98,0x74,0x01,0x01,0x98,0x74,0x68,0x50,0x0F,0xA0,0x01,0x58,0x00,0xFF,0x00,0xFF),
    _INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x00,0x01,0x04,0x00,0x08,0x08,0x27,0x27,0x22,0x2F,0x11,0x11,0x04,0x04,0x32,0x10,0x0F,0x00,0x0F,0x32,0x10,0x0D,0x00,0x0D,0x32,0x17,0x9B,0x07,0x9B,0x00,0x00,0x21,0x2F,0x01,0x00,0x21,0x38,0x01,0x55),
    _INIT_DCS_CMD(0xD1,0x37,0x0C,0xFF),
    _INIT_DCS_CMD(0xB1,0x10,0xFA,0xAF,0xAF,0x29,0x29,0xB2,0x57,0x4D,0x36,0x36,0x36,0x36,0x22,0x21,0x15,0x00),
    _INIT_DCS_CMD(0xB2,0x00,0xB0,0x47,0x80,0x00,0x14,0x44,0x2C),
    _INIT_DCS_CMD(0xE0,0x00,0x04,0x0B,0x11,0x17,0x25,0x3D,0x43,0x4B,0x48,0x64,0x6C,0x74,0x82,0x81,0x88,0x9B,0xAE,0xAD,0x56,0x5D,0x68,0x73,0x00,0x04,0x0B,0x11,0x17,0x25,0x3D,0x43,0x4B,0x48,0x64,0x6C,0x74,0x89,0x8A,0x99,0x9B,0xAE,0xAD,0x56,0x5D,0x68,0x73),
    _INIT_DCS_CMD(0xC0,0x23,0x23,0x22,0x11,0xA2,0x17,0x00,0x80,0x00,0x00,0x08,0x00,0x63,0x63),
    ...
    _INIT_DCS_CMD(0xD3,0x01,0x00,0xFC,0x00,0x00,0x11,0x10,0x00,0x0E),
    _INIT_DCS_CMD(0xBD,0x02),
    _INIT_DCS_CMD(0xB4,0x4E),
    ...
    _INIT_DCS_CMD(0xE7,0x12,0x13,0x02,0x02,0x2B,0x2B,0x0E,0x0E,0x00,0x14,0x28,0x79,0x1A,0x78,0x01,0x01,0x00,0x00,0x00,0x00,0x17,0x00),
    _INIT_DCS_CMD(0xBD,0x01),
    _INIT_DCS_CMD(0xE7,0x02,0x24,0x01,0x8F,0x0D,0xB2,0x0E),
    _INIT_DCS_CMD(0xBD,0x02),
    ...
    _INIT_DCS_CMD(0xBD,0x01),
    _INIT_DCS_CMD(0xC1,0x00,0x04,0x07,0x0B,0x0F,0x12,0x16,0x19,0x1D,0x21,0x24,0x28,0x2B,0x2E,0x31,0x35,0x38,0x3C,0x3F,0x43,0x49,0x50,0x57,0x5F,0x66,0x6D,0x75,0x7D,0x84,0x8C,0x94,0x9D,0xA4,0xAD,0xB5,0xBD,0xC6,0xCF,0xD8,0xE0,0xEA,0xEE,0xF1,0xF3,0xF5,0xF7,0x0F,0xA7,0x98,0xBC,0xDC,0xAC,0x78,0xEC,0xCA,0x43,0x61,0x80),
    _INIT_DCS_CMD(0xBD,0x02),
    _INIT_DCS_CMD(0xC1,0x00,0x04,0x07,0x0B,0x0F,0x12,0x16,0x1A,0x1E,0x21,0x25,0x28,0x2C,0x2F,0x32,0x36,0x3A,0x3D,0x41,0x44,0x4A,0x52,0x59,0x60,0x68,0x6F,0x77,0x7F,0x87,0x8F,0x97,0x9F,0xA7,0xB0,0xB8,0xC0,0xC9,0xD2,0xDB,0xE4,0xED,0xF2,0xF4,0xF7,0xF9,0xFB,0x0F,0xFD,0x36,0x69,0x21,0xCA,0x39,0x05,0x81,0x91,0x9D,0x80),
    _INIT_DCS_CMD(0xBD,0x03),
    _INIT_DCS_CMD(0xC1,0x00,0x04,0x07,0x0C,0x10,0x13,0x17,0x1B,0x1F,0x22,0x26,0x29,0x2D,0x30,0x33,0x37,0x3B,0x3E,0x42,0x45,0x4C,0x53,0x5B,0x62,0x6A,0x71,0x79,0x81,0x88,0x91,0x99,0xA1,0xA9,0xB2,0xB9,0xC2,0xCB,0xD4,0xDC,0xE6,0xF0,0xF5,0xF7,0xFA,0xFD,0xFF,0x0C,0x28,0x33,0x1A,0x76,0x72,0x24,0xC5,0x4C,0x8D,0x0E,0x80),
    _INIT_DCS_CMD(0xBD,0x00),
    _INIT_DCS_CMD(0x55,0x01),
    _INIT_DCS_CMD(0xE4,0x2D,0x41,0x2C,0x99,0xBF,0xE6,0x0C,0x33,0x66,0x99,0xCC,0xFF,0xEA,0xFF,0x03,0x1E,0x1E,0x1E,0x1E,0x00,0x00,0x05,0x01,0x14),
    _INIT_DCS_CMD(0xBD,0x01),
    _INIT_DCS_CMD(0xE4,0xE1,0xE1,0xE1,0xE1,0xE1,0xE1,0xE1,0xE1,0xC7,0xB2,0xA0,0x90,0x81,0x75,0x69,0x5F,0x55,0x4C,0x44,0x3D,0x36,0x2E,0x29,0x21,0x1B,0x15,0x10,0x0D,0x0C,0x0C,0x0C,0x54,0x55,0x55,0x55,0x55,0x55,0x55,0x55),
    _INIT_DCS_CMD(0xBD,0x00),
...
struct cust_drm_lcm m100t_hx83102e_tv084wums0_wuxga = {
	.name = "m100t_hx83102e_tv084wums0_wuxga",
