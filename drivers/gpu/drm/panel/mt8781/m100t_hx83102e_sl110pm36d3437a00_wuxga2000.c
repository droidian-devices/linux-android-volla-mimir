...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0xD2,0x27,0x27),
	_INIT_DCS_CMD(0xB1,0x10,0xFA,0xAF,0xAF,0x27,0x27,0xB1,0x4D,0x2F,0x36,0x36,0x36,0x36,0x22,0x21,0x15,0x00),
	_INIT_DCS_CMD(0xB2,0x00,0xB0,0x47,0xD0,0x00,0x26,0xB4,0x2C,0x30,0x30,0x30,0x00,0x15,0x20,0xD7,0x00),
	_INIT_DCS_CMD(0xB4,0x71,0x6F,0x0B,0x74,0xA4,0x7A,0x68,0x50,0x01,0x7B,0x01,0x58,0x00,0xFF,0x00,0xFF),
	_INIT_DCS_CMD(0xBB,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x05,0x00,0x04,0xAB,0x01),
	_INIT_DCS_CMD(0xBF,0xFC,0x85,0x80),
	_INIT_DCS_CMD(0xBA,0x70,0x03,0xA8,0x83,0xF2,0x00,0xC0,0x0D,0x10,0x00,0x00,0x00,0x0F),
	_INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x00,0x01,0x04,0x00,0x00,0x0C,0x8F,0x27,0xE8,0x4F,0x21,0x27,0x04,0x04,0x54,0x10,0x14,0x00,0x22,0x54,0x17,0xFA,0x07,0xF6,0x32,0x17,0xA8,0x07,0xA8,0x00,0x00,0x21,0x38,0x01,0x55,0x01,0x3E,0x01,0x75,0x0F),
	_INIT_DCS_CMD(0xE0,0x00,0x04,0x0D,0x13,0x1A,0x2B,0x41,0x47,0x4D,0x48,0x5F,0x64,0x68,0x77,0x75,0x7E,0x89,0x9E,0x9F,0x50,0x59,0x65,0x73,0x00,0x04,0x0D,0x13,0x1A,0x2B,0x41,0x47,0x4D,0x48,0x5F,0x64,0x68,0x77,0x75,0x7E,0x89,0x9E,0x9F,0x50,0x59,0x65,0x73),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xB1,0x01,0x9B,0x01,0x31),
	_INIT_DCS_CMD(0xD3,0x01,0x00,0xB8,0x00,0x00,0x11,0x10,0x00,0x0A,0x00,0x01),
	...
	_INIT_DCS_CMD(0xD5,0x39,0x39,0x18,0x18,0x26,0x27,0x24,0x25,0x19,0x19,0x18,0x18,0x18,0x18,0x18,0x18,0x0E,0x0F,0x0C,0x0D,0x0A,0x0B,0x08,0x09,0x06,0x07,0x04,0x05,0x02,0x03,0x00,0x01,0x1B,0x1B,0x1A,0x1A,0x22,0x23,0x20,0x21,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xD6,0x39,0x39,0x18,0x18,0x21,0x20,0x23,0x22,0x18,0x18,0x19,0x19,0x18,0x18,0x18,0x18,0x01,0x00,0x03,0x02,0x05,0x04,0x07,0x06,0x09,0x08,0x0B,0x0A,0x0D,0x0C,0x0F,0x0E,0x1B,0x1B,0x1A,0x1A,0x25,0x24,0x27,0x26,0x18,0x18,0x18,0x18),
	_INIT_DCS_CMD(0xE7,0x12,0x13,0x02,0x02,0x50,0x50,0x0E,0x0E,0x1A,0x21,0x28,0x72,0x24,0x7F,0x01,0x01,0x00,0x00,0x00,0x00,0x17,0x00,0x68),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xE7,0x01,0x20,0x01,0x93,0x0D,0xDA,0x0E),
	_INIT_DCS_CMD(0xBD,0x02),
	...
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xD8,0xEF,0xFE,0xFF,0xFF,0xFF,0xF0,0xEF,0xFE,0xFF,0xFF,0xFF,0xF0,0xE5,0x56,0x55,0x55,0x55,0x50,0xE5,0x56,0x55,0x55,0x55,0x50,0x65,0x56,0x55,0x55,0x55,0x50,0x65,0x56,0x55,0x55,0x55,0x50),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xD8,0xCF,0xFC,0xFF,0xFF,0xFF,0x00,0xCF,0xFC,0xFF,0xFF,0xFF,0x00),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xCC,0x02),
	_INIT_DCS_CMD(0xCB,0x00,0x13,0x08,0x02,0x1B),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xCB,0x00,0x03,0x00,0x01,0x76),
	_INIT_DCS_CMD(0xBD,0x00),
...
struct cust_drm_lcm m100t_hx83102e_sl110pm36d3437a00_wuxga2000 = {
	.name = "m100t_hx83102e_sl110pm36d3437a00_wuxga2000",
