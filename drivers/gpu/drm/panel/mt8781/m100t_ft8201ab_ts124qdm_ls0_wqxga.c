...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xD9,0x00,0x20,0x20),
	...
	_INIT_DCS_CMD(0xC5,0x25),
	_INIT_DCS_CMD(0x00,0x9C),
	_INIT_DCS_CMD(0xC5,0x25),
	_INIT_DCS_CMD(0x00,0xB6),
	_INIT_DCS_CMD(0xC5,0x07,0x07),
	_INIT_DCS_CMD(0x00,0xB8),
	_INIT_DCS_CMD(0xC5,0x1B,0x1B),
	_INIT_DCS_CMD(0x00,0x00),
	...
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xE1,0x05,0x0E,0x23,0x37,0x42,0x4F,0x62,0x70,0x73,0x81,0x83,0x98,0x6C,0x59,0x5A,0x50),
	_INIT_DCS_CMD(0x00,0x10),
	_INIT_DCS_CMD(0xE1,0x49,0x3F,0x32,0x29,0x22,0x14,0x06,0x02),
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xE2,0x05,0x0E,0x23,0x37,0x42,0x4F,0x62,0x70,0x73,0x81,0x83,0x98,0x6C,0x59,0x5A,0x50),
	_INIT_DCS_CMD(0x00,0x10),
	_INIT_DCS_CMD(0xE2,0x49,0x3F,0x32,0x29,0x22,0x14,0x06,0x02),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xA4,0x8C),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xF3,0x10),
	_INIT_DCS_CMD(0x00,0xA1),
	_INIT_DCS_CMD(0xB3,0x06,0x40),
	_INIT_DCS_CMD(0x00,0xA3),
	_INIT_DCS_CMD(0xB3,0x0A,0x00),
	_INIT_DCS_CMD(0x00,0xA5),
	_INIT_DCS_CMD(0xB3,0x00,0x13),
	_INIT_DCS_CMD(0x00,0xD0),
	_INIT_DCS_CMD(0xC1,0xB0),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCB,0x3F,0x33,0x30,0x3F,0x30,0x33,0x30),
	_INIT_DCS_CMD(0x00,0x87),
	_INIT_DCS_CMD(0xCB,0x3F),
	_INIT_DCS_CMD(0x00,0x88),
	_INIT_DCS_CMD(0xCB,0x00,0x3F,0x33,0x33,0x33,0x30,0x3F,0x3F),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCB,0x00,0x33,0x33,0x33,0x30,0x30,0x3F),
	_INIT_DCS_CMD(0x00,0x97),
	_INIT_DCS_CMD(0xCB,0x33),
	_INIT_DCS_CMD(0x00,0x98),
	_INIT_DCS_CMD(0xCB,0xD7,0x14,0x14,0xD4,0x14,0x14,0x14,0xD7),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCB,0x00,0xFC,0x14,0x14,0x14,0x14,0xEB,0xD4),
	_INIT_DCS_CMD(0x00,0xA8),
	_INIT_DCS_CMD(0xCB,0x28,0x14,0x14,0x14,0x14,0x14,0xC0,0x14),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCB,0xFF,0x00,0x00,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xB7),
	_INIT_DCS_CMD(0xCB,0xFF),
	_INIT_DCS_CMD(0x00,0xB8),
	_INIT_DCS_CMD(0xCB,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00),
	_INIT_DCS_CMD(0x00,0xC0),
	_INIT_DCS_CMD(0xCB,0x00,0x00,0x00,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xC7),
	_INIT_DCS_CMD(0xCB,0x00),
	_INIT_DCS_CMD(0x00,0xD0),
	_INIT_DCS_CMD(0xCB,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCC,0x38,0x2D,0x2D,0x2D,0x13,0x13,0x13,0x07),
	_INIT_DCS_CMD(0x00,0x88),
	_INIT_DCS_CMD(0xCC,0x08,0x2C,0x17,0x2B,0x2B,0x01,0x23,0x23),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCC,0x11,0x12,0x0F,0x10,0x2C,0x2C),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCD,0x38,0x2D,0x2D,0x2D,0x13,0x13,0x13,0x07),
	_INIT_DCS_CMD(0x00,0x88),
	_INIT_DCS_CMD(0xCD,0x08,0x2C,0x17,0x2B,0x2B,0x01,0x23,0x23),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCD,0x11,0x12,0x0F,0x10,0x2C,0x2C),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCC,0x38,0x2D,0x2D,0x2D,0x13,0x13,0x13,0x08),
	_INIT_DCS_CMD(0x00,0xA8),
	_INIT_DCS_CMD(0xCC,0x07,0x17,0x2C,0x2B,0x2B,0x01,0x23,0x23),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCC,0x10,0x0F,0x12,0x11,0x2C,0x2C),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCD,0x38,0x2D,0x2D,0x2D,0x13,0x13,0x13,0x08),
	_INIT_DCS_CMD(0x00,0xA8),
	_INIT_DCS_CMD(0xCD,0x07,0x17,0x2C,0x2B,0x2B,0x01,0x23,0x23),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCD,0x10,0x0F,0x12,0x11,0x2C,0x2C),
	_INIT_DCS_CMD(0x00,0x81),
	_INIT_DCS_CMD(0xC2,0x40),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xC2,0x84,0x02,0x58,0x93),
	_INIT_DCS_CMD(0x00,0x94),
	_INIT_DCS_CMD(0xC2,0x83),
	_INIT_DCS_CMD(0x00,0xE0),
	_INIT_DCS_CMD(0xC2,0x8B,0x09,0x01,0x61,0x93,0x00,0x00,0x03),
	_INIT_DCS_CMD(0x00,0xE8),
	_INIT_DCS_CMD(0xC2,0x8A,0x0A,0x01,0x61,0x93,0x00,0x00,0x03),
	_INIT_DCS_CMD(0x00,0xF0),
	_INIT_DCS_CMD(0xC2,0x89,0x07,0x01,0x61,0x93,0x00,0x00,0x03),
	_INIT_DCS_CMD(0x00,0xF8),
	_INIT_DCS_CMD(0xC2,0x88,0x08,0x01,0x61,0x93,0x00,0x00,0x03),
	_INIT_DCS_CMD(0x00,0xE0),
	_INIT_DCS_CMD(0xC3,0x36,0x24,0x00,0xC2),
	_INIT_DCS_CMD(0x00,0xE4),
	_INIT_DCS_CMD(0xC3,0x35,0x24,0x00,0x76),
	_INIT_DCS_CMD(0x00,0xE8),
	_INIT_DCS_CMD(0xC3,0x35,0x24,0x00,0x76),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xC3,0x01,0xAA,0x0A,0x0F),
	_INIT_DCS_CMD(0x00,0xFD),
	_INIT_DCS_CMD(0xCB,0x82),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xC0,0x00,0x79,0x00,0x10,0x00,0x10),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xC0,0x00,0x79,0x00,0x10,0x00,0x10),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xC0,0x00,0xF0,0x00,0x10,0x00,0x10),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xC0,0x00,0x79,0x00,0x10,0x10),
	_INIT_DCS_CMD(0x00,0xA3),
	_INIT_DCS_CMD(0xC1,0x2D,0x21,0x04),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCE,0x01,0x81,0xFF,0xFF,0x00,0x88,0x00,0xD0,0x00,0x54,0x00,0x68),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCE,0x00,0x87,0x0E,0x00,0x00,0x87,0x80,0xFF,0xFF,0x00,0x06,0x00,0x17,0x0F),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCE,0x00,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCE,0x20,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xD1),
	_INIT_DCS_CMD(0xCE,0x00,0x00,0x01,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xE1),
	_INIT_DCS_CMD(0xCE,0x09,0x02,0x30,0x02,0x30,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xF0),
	_INIT_DCS_CMD(0xCE,0x80,0x17,0x0B,0x01,0x10,0x01,0xA0,0x00,0x20,0x25),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCF,0x00,0x00,0x46,0x4A),
	_INIT_DCS_CMD(0x00,0xB5),
	_INIT_DCS_CMD(0xCF,0x05,0x05,0x00,0x04),
	_INIT_DCS_CMD(0x00,0xC0),
	_INIT_DCS_CMD(0xCF,0x09,0x09,0xEC,0xF0),
	_INIT_DCS_CMD(0x00,0xC5),
	_INIT_DCS_CMD(0xCF,0x00,0x0A,0x08,0x00),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xC4,0x88),
	_INIT_DCS_CMD(0x00,0x92),
	_INIT_DCS_CMD(0xC4,0xC0),
	_INIT_DCS_CMD(0x00,0xC5),
	_INIT_DCS_CMD(0xC3,0x00,0x00,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xD6),
	_INIT_DCS_CMD(0xC1,0x00),
	_INIT_DCS_CMD(0x00,0xD0),
	_INIT_DCS_CMD(0xC1,0x90),
	_INIT_DCS_CMD(0x00,0xBF),
	_INIT_DCS_CMD(0xC0,0x04),
	_INIT_DCS_CMD(0x00,0xD5),
	_INIT_DCS_CMD(0xC0,0xF1),
	...
	_INIT_DCS_CMD(0x00,0x9A),
	_INIT_DCS_CMD(0xF5,0x3F),
	_INIT_DCS_CMD(0x00,0x9C),
	_INIT_DCS_CMD(0xF5,0x1E),
	_INIT_DCS_CMD(0x00,0xB6),
	_INIT_DCS_CMD(0xC0,0x02),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCA,0x09,0x09,0x04),
	_INIT_DCS_CMD(0x00,0xB4),
	_INIT_DCS_CMD(0xCA,0x03),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCA,0xF0,0xD9,0xC8,0xBA,0xAF,0xA6,0x9E,0x98,0x92,0x8D,0x88,0x84),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCA,0xFB,0xFF,0x33),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCA,0x06),
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xEC,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x18,0x1C,0x40,0x20,0x28,0x30,0x38,0x01),
	_INIT_DCS_CMD(0x00,0x10),
	_INIT_DCS_CMD(0xEC,0x40,0x48,0x4F,0x57,0xF0,0x5F,0x67,0x6F,0x77,0xFF,0x7F,0x87,0x8F,0x97,0xFF),
	_INIT_DCS_CMD(0x00,0x20),
	_INIT_DCS_CMD(0xEC,0x9F,0xA7,0xAF,0xB7,0xFF,0xBF,0xC7,0xCF,0xD7,0xAF,0xDF,0xE7,0xEE,0xF6,0xFA),
	_INIT_DCS_CMD(0x00,0x30),
	_INIT_DCS_CMD(0xEC,0xFA,0xFC,0xFD,0x3F),
	_INIT_DCS_CMD(0x00,0x40),
	_INIT_DCS_CMD(0xEC,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x18,0x1C,0x00,0x20,0x28,0x30,0x38,0x00),
	_INIT_DCS_CMD(0x00,0x50),
	_INIT_DCS_CMD(0xEC,0x40,0x48,0x50,0x58,0x00,0x60,0x68,0x70,0x78,0x00,0x80,0x88,0x90,0x98,0x00),
	_INIT_DCS_CMD(0x00,0x60),
	_INIT_DCS_CMD(0xEC,0xA0,0xA8,0xB0,0xB8,0x00,0xC0,0xC8,0xD0,0xD8,0x00,0xE0,0xE8,0xF0,0xF8,0x00),
	_INIT_DCS_CMD(0x00,0x70),
	_INIT_DCS_CMD(0xEC,0xFC,0xFE,0xFF,0x00),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xEC,0x00,0x03,0x07,0x0B,0x6C,0x0F,0x13,0x16,0x1A,0xb1,0x1e,0x26,0x2E,0x35,0xC5),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xEC,0x3D,0x45,0x4D,0x54,0x86,0x5C,0x64,0x6B,0x73,0x61,0x7B,0x82,0x8A,0x91,0xD8),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xEC,0x99,0xA1,0xA8,0xB0,0x72,0xB8,0xBF,0xC7,0xCF,0x6C,0xD7,0xDE,0xE7,0xEE,0xCC),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xEC,0xF2,0xF4,0xF5,0x2B),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xB4,0x00,0x28,0x02,0x00,0x04,0x9F,0x00,0x0B,0x02,0x77,0x01,0xB1,0x10,0xD0),
	_INIT_DCS_CMD(0x00,0xBE),
	_INIT_DCS_CMD(0xB4,0x00,0x80),
	_INIT_DCS_CMD(0x00,0xD5),
	_INIT_DCS_CMD(0xC1,0x80),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xB0,0x92),
	...
	_INIT_DCS_CMD(0xC5,0x09),
	_INIT_DCS_CMD(0x00,0xB6),
	_INIT_DCS_CMD(0xC5,0x05,0x05),
	_INIT_DCS_CMD(0x00,0xB8),
	_INIT_DCS_CMD(0xC5,0x19,0x19),
	_INIT_DCS_CMD(0x00,0x91),
	_INIT_DCS_CMD(0xA5,0x40),
	_INIT_DCS_CMD(0x00,0xB2),
	_INIT_DCS_CMD(0xCE,0x7A),
	_INIT_DCS_CMD(0x00,0xA4),
	_INIT_DCS_CMD(0xF3,0x0B),
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xFA,0x5A),
...
struct cust_drm_lcm m100t_ft8201ab_ts124qdm_ls0_wqxga = {
	.name = "m100t_ft8201ab_ts124qdm_ls0_wqxga",
