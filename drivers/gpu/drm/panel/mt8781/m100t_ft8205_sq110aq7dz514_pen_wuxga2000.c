...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xE1,0x00,0x04,0x11,0x1E,0x27,0x31,0x41,0x4F,0x52,0x5F,0x63,0x79,0x88,0x73,0x71,0x65),
	_INIT_DCS_CMD(0x00,0x10),
	_INIT_DCS_CMD(0xE1,0x5B,0x4F,0x3E,0x34,0x2B,0x1E,0x16,0x15),
	_INIT_DCS_CMD(0x00,0x00),
	_INIT_DCS_CMD(0xE2,0x00,0x04,0x11,0x1E,0x27,0x31,0x41,0x4F,0x52,0x5F,0x63,0x79,0x88,0x73,0x71,0x65),
	_INIT_DCS_CMD(0x00,0x10),
	_INIT_DCS_CMD(0xE2,0x5B,0x4F,0x3E,0x34,0x2B,0x1B,0x0C,0x0A),
	...
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xC0,0x00,0x8C,0x00,0xDC,0x00,0x10),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xC0,0x00,0x8C,0x00,0xDC,0x00,0x10),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xC0,0x00,0xF0,0x00,0xDC,0x00,0x10),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xC0,0x00,0xA7,0x00,0xDC,0x10),
	_INIT_DCS_CMD(0x00,0xA3),
	_INIT_DCS_CMD(0xC1,0x00,0x24,0x00,0x24,0x00,0x04),
	_INIT_DCS_CMD(0x00,0x80),
	_INIT_DCS_CMD(0xCE,0x01,0x81,0x0B,0x21,0x00,0x35,0x00,0xAC,0x00,0x2A,0x00,0x3A),
	_INIT_DCS_CMD(0x00,0x90),
	_INIT_DCS_CMD(0xCE,0x00,0x88,0x0C,0x66,0x00,0x88,0x80,0x0B,0x21,0x00,0x03,0x00,0x1C,0x0C),
	_INIT_DCS_CMD(0x00,0xA0),
	_INIT_DCS_CMD(0xCE,0x10,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xB0),
	_INIT_DCS_CMD(0xCE,0x62,0x00,0x00),
	_INIT_DCS_CMD(0x00,0xCC),
	_INIT_DCS_CMD(0xCE,0x07,0xF8),
	_INIT_DCS_CMD(0x00,0xD0),
	_INIT_DCS_CMD(0xCE,0x01,0x00,0x0F,0x01,0x01,0x00,0xDE,0x01),
	_INIT_DCS_CMD(0x00,0xE1),
	_INIT_DCS_CMD(0xCE,0x0A,0x01,0x6B,0x02,0x37 ,0x00,0x82),
	_INIT_DCS_CMD(0x00,0xF0),
	_INIT_DCS_CMD(0xCE,0x00,0x11,0x08 ,0x01,0x2D,0x01,0xD6,0x00,0xEC,0x1A),
	_INIT_DCS_CMD(0x00,0xB0),
...
struct cust_drm_lcm m100t_ft8205_sq110aq7dz514_pen_wuxga2000 = {
	.name = "m100t_ft8205_sq110aq7dz514_pen_wuxga2000",
