...
//-----|---|------|-------|--------|-----|-----|-----|--------|--------|---------------
 { 16, 	16, 298, 	1920, 	2250, 	3, 		14, 	19, 	1200, 	1236, 	16600 };               //
...
// hfp,	hs,	hbp,	hact,	htotal,	vfp,	vs,	vbp,	vact,	vtotal,	pixel_CLK/10000
//-----|---|------|-------|--------|-----|-----|-----|--------|--------|---------------
  { 48, 32, 80, 	2496, 	2656, 	3, 		10, 	35, 	1664, 	1712, 	16369 };                     //36fps
/*******************************************************************
   全志平台的屏参 lcd_hbp 是 上面参数 hbp + hs 的和；
   The lcd_hbp of Allwiner platform is the sum of the above parameters hbp + hs;
...
static int common_panel_unprepare_power(struct drm_panel *panel)
{
    ...
    mdelay(10);
    cust_gpio_set_value(CUST_GPIO_BIAS_EN, 0); 
    mdelay(10);
...
static int common_panel_prepare_power(struct drm_panel *panel)
{
    ...
    mdelay(10);
    cust_gpio_set_value(CUST_GPIO_BIAS_EN, 1); 
    mdelay(10);
...
struct cust_drm_lcm m100t_ol_lt8911exb_sl140pn50d3381a00_wuxga = {
	.name = "m100t_ol_lt8911exb_sl140pn50d3381a00_wuxga",
