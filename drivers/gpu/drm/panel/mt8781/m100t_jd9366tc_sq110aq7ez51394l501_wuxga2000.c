...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DCS_CMD(0x31,0x22),
    _INIT_DCS_CMD(0x32,0x10),
    _INIT_DCS_CMD(0x33,0x36),
    _INIT_DCS_CMD(0x3d,0x42),
    _INIT_DCS_CMD(0x3f,0x61),
    _INIT_DCS_CMD(0x42,0x82),
    _INIT_DCS_CMD(0x43,0x70),
    _INIT_DCS_CMD(0x44,0x21),
    _INIT_DCS_CMD(0x49,0x82),
    _INIT_DCS_CMD(0x4A,0x3F),
    _INIT_DCS_CMD(0x41,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x0C,0x00,0x00,0x00,0x00),
    _INIT_DCS_CMD(0x5a,0x23,0x23,0x23,0x23,0x23,0x23,0x23,0x19,0x23,0x21,0x20),
    _INIT_DCS_CMD(0x5b,0x17,0x15,0x13,0x11,0x0f,0x0d,0x0b,0x09,0x01,0x23,0x23),
    _INIT_DCS_CMD(0x5c,0x23,0x23,0x23,0x23,0x23,0x23,0x23,0x18,0x23,0x21,0x20),
    _INIT_DCS_CMD(0x5d,0x16,0x14,0x12,0x10,0x0E,0x0C,0x0A,0x08,0x00,0x23,0x23),
    _INIT_DCS_CMD(0x4E,0xFF,0xFF),
    _INIT_DCS_CMD(0x50,0x01,0x01),
    _INIT_DCS_CMD(0x55,0x00,0x00),
    _INIT_DCS_CMD(0x56,0x00,0x00),
    _INIT_DCS_CMD(0x6F,0x00,0x04,0x00),
    _INIT_DCS_CMD(0x70,0x00,0x04,0x00),
    ...
    _INIT_DCS_CMD(0x40,0x3D),
    _INIT_DCS_CMD(0x41,0x3D),
    _INIT_DCS_CMD(0x42,0x0F),
    _INIT_DCS_CMD(0x47,0x03),
    _INIT_DCS_CMD(0x48,0x0C),
    _INIT_DCS_CMD(0x4A,0x17),
    _INIT_DCS_CMD(0x4B,0x1A),
    ...
    _INIT_DCS_CMD(0x33,0x00,0x5F),
    _INIT_DCS_CMD(0x3c,0x00,0x92),
    _INIT_DCS_CMD(0x43,0xab),
    _INIT_DCS_CMD(0x44,0x2b),
    _INIT_DCS_CMD(0x3e,0x00,0x00,0x08,0x0D,0x13),
    _INIT_DCS_CMD(0x3f,0x1A,0x30,0x36,0x3D,0x39,0x56,0x5E,0x67,0x7A,0x7C,0x88,0x95,0xA5,0xA3),
    _INIT_DCS_CMD(0x40,0x50,0x58,0x5F,0x65,0x00,0x00,0x08,0x0D,0x13),
    _INIT_DCS_CMD(0x41,0x1A,0x30,0x36,0x3D,0x39,0x56,0x5E,0x67,0x7A,0x7C,0x88,0x95,0xA5,0xA3),
    _INIT_DCS_CMD(0x42,0x50,0x58,0x70,0x73), //add
    _INIT_DCS_CMD(0x45,0x59), //modify
    _INIT_DCS_CMD(0x46,0x45), //modify
    _INIT_DCS_CMD(0x48,0x7E), //modify
    _INIT_DCS_CMD(0x49,0x1F), //modify
    _INIT_DCS_CMD(0x4A,0x1A), //modify
    _INIT_DCS_CMD(0x4E,0x0A),
    _INIT_DCS_CMD(0x4F,0x96),
    _INIT_DCS_CMD(0x50,0x50),
    _INIT_DCS_CMD(0x5A,0x18),
    _INIT_DCS_CMD(0x5B,0x72),
    _INIT_DCS_CMD(0x60,0x13),
    _INIT_DCS_CMD(0x61,0x3F),
    _INIT_DCS_CMD(0x67,0x14),
...
struct cust_drm_lcm m100t_jd9366tc_sq110aq7ez51394l501_wuxga2000 = {
	.name = "m100t_jd9366tc_sq110aq7ez51394l501_wuxga2000",
