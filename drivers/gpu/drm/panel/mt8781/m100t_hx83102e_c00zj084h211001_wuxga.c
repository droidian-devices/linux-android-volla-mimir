...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DCS_CMD(0xB1,0x10,0xFA,0xAF,0xAF,0x31,0x31,0xB1,0x4D,0x43,0x36,0x36,0x36,0x36,0x22,0x21,0x15,0x00),
    _INIT_DCS_CMD(0xB2,0x00,0xB0,0x47,0x80,0x00,0x26,0xE0,0x29,0x13,0x03,0x00,0x00,0x15,0x20,0xD7,0x00),
    _INIT_DCS_CMD(0xB4,0x6A,0x70,0x6A,0x70,0x6A,0x90,0x6A,0x90,0x01,0x9F,0x01,0x58,0x00,0xFF,0x00,0xFF),
    _INIT_DCS_CMD(0xD2,0x31,0x31),
    _INIT_DCS_CMD(0xB6,0x34,0x34,0xE3),
    _INIT_DCS_CMD(0xBF,0xFC,0x85,0x80,0x9C,0x36,0x00,0x04),
    _INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x00,0x3C,0xE8,0x00,0x00,0x00,0x37,0x47,0x44,0x0F,0x26,0x26,0x00,0x00,0x65,0x10,0x1B,0x00,0x1B,0x32,0x17,0xA8,0x07,0xA8,0x31,0x14,0x00,0x00,0x00,0x00,0x00,0x2B,0x50,0xB6,0xC8,0x2C,0x4F,0xB6,0xC8,0x0F),
    ...
    _INIT_DCS_CMD(0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x18,0x18,0x24,0x25,0x20,0x21,0x1B,0x1B,0x1A,0x1A,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x22,0x23,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18),
    _INIT_DCS_CMD(0xD6,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x19,0x19,0x23,0x22,0x21,0x20,0x1B,0x1A,0x1A,0x1B,0x07,0x06,0x05,0x04,0x03,0x02,0x01,0x00,0x25,0x24,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18),
    ...
    //_INIT_DCS_CMD(0xCB,0x80,0x36,0x12,0x16,0xc0,0x28,0x54,0x84,0x02,0x34),//
    _INIT_DCS_CMD(0xCB,0x80,0x36,0x12,0x16,0xc0,0x28,0x54,0x84,0x22),//
    _INIT_DCS_CMD(0xBD,0x00),
...
#else
    _INIT_DCS_CMD(0xB9,0x83,0x10,0x2E),  //BIST
...
struct cust_drm_lcm m100t_hx83102e_c00zj084h211001_wuxga = {
	.name = "m100t_hx83102e_c00zj084h211001_wuxga",
