...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DCS_CMD(0x07,0x82),
    _INIT_DCS_CMD(0x08,0x5A),
    _INIT_DCS_CMD(0x0D,0x63),
    _INIT_DCS_CMD(0x0E,0x9B),
    _INIT_DCS_CMD(0x0F,0x73),
    _INIT_DCS_CMD(0x89,0x79),
    _INIT_DCS_CMD(0x8A,0x79),
    _INIT_DCS_CMD(0x8B,0x79),
    _INIT_DCS_CMD(0x8C,0x79),
    _INIT_DCS_CMD(0x95,0xEB),
    _INIT_DCS_CMD(0x96,0xEB),
    _INIT_DCS_CMD(0x30,0x11),
    _INIT_DCS_CMD(0x6D,0xAA),
    _INIT_DCS_CMD(0x75,0xC4),
    _INIT_DCS_CMD(0x77,0xB3),
    _INIT_DCS_CMD(0xFF,0x20),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0xB0,0x00,0x08,0x00,0x1D,0x00,0x3F,0x00,0x5B,0x00,0x75,0x00,0x8B,0x00,0xA0,0x00,0xB1),
    _INIT_DCS_CMD(0xB1,0x00,0xC3,0x00,0xFC,0x01,0x2A,0x01,0x71,0x01,0xA5,0x01,0xF4,0x02,0x37,0x02,0x39),
    _INIT_DCS_CMD(0xB2,0x02,0x77,0x02,0xBB,0x02,0xE6,0x03,0x1C,0x03,0x3F,0x03,0x6B,0x03,0x7A,0x03,0x89),
    _INIT_DCS_CMD(0xB3,0x03,0x9A,0x03,0xAC,0x03,0xBF,0x03,0xE2,0x03,0xFB,0x03,0xFF),
    _INIT_DCS_CMD(0xB4,0x00,0x08,0x00,0x1D,0x00,0x3F,0x00,0x5B,0x00,0x75,0x00,0x8B,0x00,0xA0,0x00,0xB1),
    _INIT_DCS_CMD(0xB5,0x00,0xC3,0x00,0xFC,0x01,0x2A,0x01,0x71,0x01,0xA5,0x01,0xF4,0x02,0x37,0x02,0x39),
    _INIT_DCS_CMD(0xB6,0x02,0x77,0x02,0xBB,0x02,0xE6,0x03,0x1C,0x03,0x3F,0x03,0x6B,0x03,0x7A,0x03,0x89),
    _INIT_DCS_CMD(0xB7,0x03,0x9A,0x03,0xAC,0x03,0xBF,0x03,0xE2,0x03,0xFB,0x03,0xFF),
    _INIT_DCS_CMD(0xB8,0x00,0x08,0x00,0x1D,0x00,0x3F,0x00,0x5B,0x00,0x75,0x00,0x8B,0x00,0xA0,0x00,0xB1),
    _INIT_DCS_CMD(0xB9,0x00,0xC3,0x00,0xFC,0x01,0x2A,0x01,0x71,0x01,0xA5,0x01,0xF4,0x02,0x37,0x02,0x39),
    _INIT_DCS_CMD(0xBA,0x02,0x77,0x02,0xBB,0x02,0xE6,0x03,0x1C,0x03,0x3F,0x03,0x6B,0x03,0x7A,0x03,0x89),
    _INIT_DCS_CMD(0xBB,0x03,0x9A,0x03,0xAC,0x03,0xBF,0x03,0xE2,0x03,0xFB,0x03,0xFF),
    ...
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0xB0, 0x00,0x00,0x00,0x15,0x00,0x37,0x00,0x53,0x00,0x6D,0x00,0x83,0x00,0x98,0x00,0xA9),
    _INIT_DCS_CMD(0xB1, 0x00,0xBB,0x00,0xF4,0x01,0x22,0x01,0x69,0x01,0x9D,0x01,0xEC,0x02,0x2F,0x02,0x31),
    _INIT_DCS_CMD(0xB2, 0x02,0x6F,0x02,0xB3,0x02,0xDE,0x03,0x14,0x03,0x37,0x03,0x63,0x03,0x72,0x03,0x81),
    _INIT_DCS_CMD(0xB3, 0x03,0x92,0x03,0xA4,0x03,0xB7,0x03,0xDA,0x03,0xF3,0x03,0xF7),
    _INIT_DCS_CMD(0xB4, 0x00,0x00,0x00,0x15,0x00,0x37,0x00,0x53,0x00,0x6D,0x00,0x83,0x00,0x98,0x00,0xA9),
    _INIT_DCS_CMD(0xB5, 0x00,0xBB,0x00,0xF4,0x01,0x22,0x01,0x69,0x01,0x9D,0x01,0xEC,0x02,0x2F,0x02,0x31),
    _INIT_DCS_CMD(0xB6, 0x02,0x6F,0x02,0xB3,0x02,0xDE,0x03,0x14,0x03,0x37,0x03,0x63,0x03,0x72,0x03,0x81),
    _INIT_DCS_CMD(0xB7, 0x03,0x92,0x03,0xA4,0x03,0xB7,0x03,0xDA,0x03,0xF3,0x03,0xF7),
    _INIT_DCS_CMD(0xB8, 0x00,0x00,0x00,0x15,0x00,0x37,0x00,0x53,0x00,0x6D,0x00,0x83,0x00,0x98,0x00,0xA9),
    _INIT_DCS_CMD(0xB9, 0x00,0xBB,0x00,0xF4,0x01,0x22,0x01,0x69,0x01,0x9D,0x01,0xEC,0x02,0x2F,0x02,0x31),
    _INIT_DCS_CMD(0xBA, 0x02,0x6F,0x02,0xB3,0x02,0xDE,0x03,0x14,0x03,0x37,0x03,0x63,0x03,0x72,0x03,0x81),
    _INIT_DCS_CMD(0xBB, 0x03,0x92,0x03,0xA4,0x03,0xB7,0x03,0xDA,0x03,0xF3,0x03,0xF7),
    _INIT_DCS_CMD(0xFF, 0x24),
    _INIT_DCS_CMD(0xFB, 0x01),
    _INIT_DCS_CMD(0x00, 0x26),
    _INIT_DCS_CMD(0x01, 0x26),
    ...
    _INIT_DCS_CMD(0x0C, 0x0E),
    _INIT_DCS_CMD(0x0D, 0x0E),
    _INIT_DCS_CMD(0x0E, 0x0F),
    ...
    _INIT_DCS_CMD(0x16, 0x26),
    _INIT_DCS_CMD(0x17, 0x26),
    ...
    _INIT_DCS_CMD(0x1E, 0x0C),
    _INIT_DCS_CMD(0x1F, 0x0C),
    _INIT_DCS_CMD(0x20, 0x0D),
    _INIT_DCS_CMD(0x21, 0x0D),
    _INIT_DCS_CMD(0x22, 0x0E),
    _INIT_DCS_CMD(0x23, 0x0E),
    _INIT_DCS_CMD(0x24, 0x0F),
    ...
    _INIT_DCS_CMD(0x33, 0x0A),
    _INIT_DCS_CMD(0x34, 0x44),
    ...
    _INIT_DCS_CMD(0x06, 0x3C),
    _INIT_DCS_CMD(0x0C, 0x15),
    _INIT_DCS_CMD(0x0D, 0x0B),
    _INIT_DCS_CMD(0x0F, 0x0A),
    _INIT_DCS_CMD(0x11, 0x00),   
    _INIT_DCS_CMD(0x12, 0x50),   
    _INIT_DCS_CMD(0x13, 0x44),  
    _INIT_DCS_CMD(0x14, 0x5C), 
    _INIT_DCS_CMD(0x16, 0x10),
    _INIT_DCS_CMD(0x19, 0x10),   
    _INIT_DCS_CMD(0x1A, 0xE0),      
    _INIT_DCS_CMD(0x1B, 0x0F),   
    _INIT_DCS_CMD(0x1C, 0xE0),
    _INIT_DCS_CMD(0x2A, 0x10),   
    _INIT_DCS_CMD(0x2B, 0xE0),
    _INIT_DCS_CMD(0x1D, 0x00),
    _INIT_DCS_CMD(0x1E, 0x72),
    _INIT_DCS_CMD(0x1F, 0x72), 
    _INIT_DCS_CMD(0x24, 0x00), 
    _INIT_DCS_CMD(0x25, 0x72),    
    _INIT_DCS_CMD(0x2F, 0x05),
    _INIT_DCS_CMD(0x30, 0x72),
    _INIT_DCS_CMD(0x31, 0x05),
    _INIT_DCS_CMD(0x32, 0x8A),
    _INIT_DCS_CMD(0x39, 0x00),   
    _INIT_DCS_CMD(0x3A, 0x72),
    ...
    _INIT_DCS_CMD(0xA9, 0x43),
    _INIT_DCS_CMD(0xAA, 0x42),
    _INIT_DCS_CMD(0xAB, 0x41),
    _INIT_DCS_CMD(0xAC, 0x40),
    _INIT_DCS_CMD(0xAD, 0x3F),
    _INIT_DCS_CMD(0xAE, 0x3E),
    _INIT_DCS_CMD(0xAF, 0x3D),
    _INIT_DCS_CMD(0xB0, 0x3C),
    _INIT_DCS_CMD(0xB1, 0x3B),
    _INIT_DCS_CMD(0xB2, 0x3A),
    _INIT_DCS_CMD(0xB3, 0x39),
    _INIT_DCS_CMD(0xFF, 0x27),
    _INIT_DCS_CMD(0xFB, 0x01),
    _INIT_DCS_CMD(0x56, 0x06),
    _INIT_DCS_CMD(0x58, 0x80),
    _INIT_DCS_CMD(0x59, 0x5E),
    _INIT_DCS_CMD(0x5A, 0x00),
    _INIT_DCS_CMD(0x5B, 0x18),
    _INIT_DCS_CMD(0x5C, 0x00),
    _INIT_DCS_CMD(0x5D, 0x06),
    _INIT_DCS_CMD(0x5E, 0x20),
    _INIT_DCS_CMD(0x5F, 0x10),
    _INIT_DCS_CMD(0x60, 0x00),
    _INIT_DCS_CMD(0x61, 0x25),
    _INIT_DCS_CMD(0x62, 0x00),
    _INIT_DCS_CMD(0x63, 0x01),
    _INIT_DCS_CMD(0x64, 0x21),
    _INIT_DCS_CMD(0x65, 0x23),
    _INIT_DCS_CMD(0x66, 0x00),
    _INIT_DCS_CMD(0x67, 0x01),
    _INIT_DCS_CMD(0x68, 0x22),
    ...
    _INIT_DCS_CMD(0x11,0x00),
    _INIT_DCS_CMD(0x12,0x50),
    _INIT_DCS_CMD(0x13,0x91),
    _INIT_DCS_CMD(0x14,0x92),
    _INIT_DCS_CMD(0x16,0x10),
    _INIT_DCS_CMD(0x19,0x0D),
    _INIT_DCS_CMD(0x1A,0xDC),
    _INIT_DCS_CMD(0x1B,0x0C),
    _INIT_DCS_CMD(0x1C,0xD6),
    _INIT_DCS_CMD(0x2A,0x0D),
    _INIT_DCS_CMD(0x2B,0xDC),
    _INIT_DCS_CMD(0x1D,0x00),
    _INIT_DCS_CMD(0x1E,0x76),
    _INIT_DCS_CMD(0x1F,0x76),
    _INIT_DCS_CMD(0x2F,0x0A),
    _INIT_DCS_CMD(0x30,0x76),
    _INIT_DCS_CMD(0x31,0x0A),
    _INIT_DCS_CMD(0x32,0x8F),
    _INIT_DCS_CMD(0x33,0x11),
    _INIT_DCS_CMD(0x34,0x11),
    _INIT_DCS_CMD(0x35,0x91),
    _INIT_DCS_CMD(0x36,0x78),
    _INIT_DCS_CMD(0x37,0x16),
    _INIT_DCS_CMD(0x39,0x0C),
    _INIT_DCS_CMD(0x3A,0x77),
    _INIT_DCS_CMD(0x3B,0x06),
    _INIT_DCS_CMD(0xFF,0x27),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0x58,0x80),
    _INIT_DCS_CMD(0x59,0x3B),
    _INIT_DCS_CMD(0x5A,0x00),
    ...
    _INIT_DCS_CMD(0x5F,0x10),
    _INIT_DCS_CMD(0x60,0x00),
    _INIT_DCS_CMD(0x61,0x1A),
    _INIT_DCS_CMD(0x62,0x00),
    _INIT_DCS_CMD(0x63,0x01),
    _INIT_DCS_CMD(0x64,0x1F),
    _INIT_DCS_CMD(0x65,0x19),
    _INIT_DCS_CMD(0x66,0x00),
    _INIT_DCS_CMD(0x67,0x01),
    _INIT_DCS_CMD(0x68,0x1F),
    _INIT_DCS_CMD(0xFF,0x2A),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0x24,0x00),
    _INIT_DCS_CMD(0x25,0x76),
    _INIT_DCS_CMD(0x27,0x00),
    _INIT_DCS_CMD(0x28,0x1A),
    _INIT_DCS_CMD(0x29,0x00),
    _INIT_DCS_CMD(0x2A,0x1A),
    ...
    _INIT_DCS_CMD(0x14,0xF5),
    _INIT_DCS_CMD(0xFF,0x10),
    _INIT_DCS_CMD(0xFB,0x01),
    _INIT_DCS_CMD(0xFF,0x27),
    _INIT_DCS_CMD(0xD1,0x24),
    _INIT_DCS_CMD(0xD2,0x53),
    _INIT_DCS_CMD(0xFF,0x24),
    _INIT_DCS_CMD(0xC2,0xDA),
    _INIT_DCS_CMD(0xFF,0x27),
    _INIT_DCS_CMD(0xFB,0x01),
    ...
    _INIT_DCS_CMD(0x3B,0x03,0x55,0x1A,0x04,0x04),
    _INIT_DCS_CMD(0xFF,0x10),
    _INIT_DCS_CMD(0xFB,0x01),
...
struct cust_drm_lcm m100t_nt36523_tv120c9m_wuxga2000 = {
	.name = "m100t_nt36523_tv120c9m_wuxga2000",
