...
//======voltage set(AVDD/AVEE=+6V/-6V,VGHO/VGLO=19V/-11V,GVDD/NGVDD=5.5V/-5.5V)==========
    _INIT_DCS_CMD(0x00,0x93), //VGH_N 20V  step=0.1V
    _INIT_DCS_CMD(0xC5,0x84),
    _INIT_DCS_CMD(0x00,0x97), //VGH_I 20V  step=0.1V
    _INIT_DCS_CMD(0xC5,0x84),
    _INIT_DCS_CMD(0x00,0x9E),
    _INIT_DCS_CMD(0xC5,0x0A),  //2AVDD-2AVEE
    _INIT_DCS_CMD(0x00,0x9A),  //VGL_N -12V    step=0.1V
    _INIT_DCS_CMD(0xC5,0xC3),  //2AVEE-AVDD
    _INIT_DCS_CMD(0x00,0x9C),  //VGL_I -12V    step=0.1V
    _INIT_DCS_CMD(0xC5,0xC3), //2AVEE-AVDD
    _INIT_DCS_CMD(0x00,0xB6),
    _INIT_DCS_CMD(0xC5,0x75,0x75),   //VGHO1_N_I 19V   step=0.1V
    _INIT_DCS_CMD(0x00,0xB8),
    _INIT_DCS_CMD(0xC5,0x39,0x39),  //VGLO1_N_I -11V   step=0.1V
    _INIT_DCS_CMD(0x00,0xA0),
    _INIT_DCS_CMD(0xA5,0x04),     //GVDD&NGVDD EN
    _INIT_DCS_CMD(0x00,0x00),
    _INIT_DCS_CMD(0xD8,0xC8,0xC8),  //GVDDP/N 5.5V/-5.5V   step=0.01V
//_INIT_DCS_CMD(0x00,0x00),
//_INIT_DCS_CMD(0xD9,0x00,0x82,0x82),  //VCOM(-1V) step=0.01V
...
//_INIT_DCS_CMD(0xC0,0x10),//PowerOn&Off BlankFrame Number
//==========gamma==============
//Analog Gamma
    _INIT_DCS_CMD(0x00,0x00),
    _INIT_DCS_CMD(0xE1,0x04,0x0D,0x20,0x33,0x3E,0x4A,0x5C,0x6A,0x6C,0x7A,0x7C,0x92,0x70,0x5D,0x5E,0x53),
    _INIT_DCS_CMD(0x00,0x10),
    _INIT_DCS_CMD(0xE1,0x4C,0x41,0x32,0x2A,0x22,0x13,0x05,0x02),
    _INIT_DCS_CMD(0x00,0x00),
    _INIT_DCS_CMD(0xE2,0x04,0x0D,0x20,0x33,0x3E,0x4A,0x5C,0x6A,0x6C,0x7A,0x7C,0x92,0x70,0x5D,0x5E,0x53),
    _INIT_DCS_CMD(0x00,0x10),
    _INIT_DCS_CMD(0xE2,0x4C,0x41,0x32,0x2A,0x22,0x13,0x05,0x02),
//reg_sd_sap
    _INIT_DCS_CMD(0x00,0x80),
...
//SKIP LVD Power-OFF0
    _INIT_DCS_CMD(0x00,0x80),
    _INIT_DCS_CMD(0xCB,0x33,0x33,0x00,0x33,0x30,0x33,0x30),
    _INIT_DCS_CMD(0x00,0x87),
    _INIT_DCS_CMD(0xCB,0x33),
    _INIT_DCS_CMD(0x00,0x88),
    _INIT_DCS_CMD(0xCB,0x33,0x33,0x33,0x33,0x33,0x30,0x33,0x33),
...
//Power-OFF NORM
    _INIT_DCS_CMD(0x00,0x98),
    _INIT_DCS_CMD(0xCB,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x00),
    _INIT_DCS_CMD(0x00,0xA0),
    _INIT_DCS_CMD(0xCB,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04),
...
//U2D
    _INIT_DCS_CMD(0x00,0x80),
    _INIT_DCS_CMD(0xCC,0x29,0x29,0x2A,0x2A,0x0A,0x0A,0x06,0x06),
    _INIT_DCS_CMD(0x00,0x88),
    _INIT_DCS_CMD(0xCC,0x0F,0x0F,0x35,0x35,0x34,0x34,0x16,0x16),
    _INIT_DCS_CMD(0x00,0x90),
    _INIT_DCS_CMD(0xCC,0x14,0x14,0x1A,0x1A,0x18,0x18),
    _INIT_DCS_CMD(0x00,0x80),
    _INIT_DCS_CMD(0xCD,0x29,0x29,0x2A,0x2A,0x09,0x09,0x05,0x05),
    _INIT_DCS_CMD(0x00,0x88),
    _INIT_DCS_CMD(0xCD,0x0F,0x0F,0x35,0x35,0x34,0x34,0x15,0x15),
    _INIT_DCS_CMD(0x00,0x90),
    _INIT_DCS_CMD(0xCD,0x13,0x13,0x19,0x19,0x17,0x17),
//D2U
    _INIT_DCS_CMD(0x00,0xA0),
    _INIT_DCS_CMD(0xCC,0x29,0x29,0x2A,0x2A,0x09,0x09,0x05,0x05),
    _INIT_DCS_CMD(0x00,0xA8),
    _INIT_DCS_CMD(0xCC,0x0F,0x0F,0x35,0x35,0x34,0x34,0x17,0x17),
    _INIT_DCS_CMD(0x00,0xB0),
    _INIT_DCS_CMD(0xCC,0x19,0x19,0x13,0x13,0x15,0x15),
    _INIT_DCS_CMD(0x00,0xA0),
    _INIT_DCS_CMD(0xCD,0x29,0x29,0x2A,0x2A,0x0A,0x0A,0x06,0x06),
    _INIT_DCS_CMD(0x00,0xA8),
    _INIT_DCS_CMD(0xCD,0x0F,0x0F,0x35,0x35,0x34,0x34,0x18,0x18),
    _INIT_DCS_CMD(0x00,0xB0),
    _INIT_DCS_CMD(0xCD,0x1A,0x1A,0x14,0x14,0x16,0x16),
//goa_vstx_shift_cnt_sel (20200812)
    _INIT_DCS_CMD(0x00,0x81),
    _INIT_DCS_CMD(0xC2,0x40),	//C281[6]=1

//VST3
    _INIT_DCS_CMD(0x00,0x88),//STV1
    _INIT_DCS_CMD(0xC2,0x8A,0x04,0x7C,0x9D),
//VST4
    _INIT_DCS_CMD(0x00,0x8C),//STV3
    _INIT_DCS_CMD(0xC2,0x89,0x04,0x7C,0x9D),

//VST7 OR VEND7
    _INIT_DCS_CMD(0x00,0x98),//STV2
    _INIT_DCS_CMD(0xC2,0x90,0x24,0x7C,0x9D),
//VST8 OR VEND8
    _INIT_DCS_CMD(0x00,0x9C),//STV4
    _INIT_DCS_CMD(0xC2,0x8F,0x24,0x7C,0x9D),
//VEND7
    _INIT_DCS_CMD(0x00,0xB8),
    _INIT_DCS_CMD(0xC2,0x11,0x04,0x7C,0x9D),
//VEND8
    _INIT_DCS_CMD(0x00,0xBC),
    _INIT_DCS_CMD(0xC2,0x12,0x04,0x7C,0x9D),
//CLKC
    _INIT_DCS_CMD(0x00,0x80),//Gate5:CLK5
    _INIT_DCS_CMD(0xC3,0x88,0x0D,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0x88),//Gate6:CLK6
    _INIT_DCS_CMD(0xC3,0x87,0x0E,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0x90),//Gate7:CLK7
    _INIT_DCS_CMD(0xC3,0x86,0x0F,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0x98),//Gate8:CLK8
    _INIT_DCS_CMD(0xC3,0x85,0x10,0x24,0x89,0xAA,0x00,0x02,0x07),

//CLKD
    _INIT_DCS_CMD(0x00,0xC0),//Gate1:CLK1
    _INIT_DCS_CMD(0xCD,0x84,0x09,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0xC8),//Gate2:CLK2
    _INIT_DCS_CMD(0xCD,0x83,0x0A,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0xD0),//Gate3:CLK3
    _INIT_DCS_CMD(0xCD,0x82,0x0B,0x24,0x89,0xAA,0x00,0x02,0x07),
    _INIT_DCS_CMD(0x00,0xD8),//Gate4:CLK4
    _INIT_DCS_CMD(0xCD,0x81,0x0C,0x24,0x89,0xAA,0x00,0x02,0x07),

//ECLK
    _INIT_DCS_CMD(0x00,0xF0),//VDD1&VDD2:2S SWITCH
    _INIT_DCS_CMD(0xCC,0x79,0x97,0x00,0x00,0x00),
...
//=============== ## TCON Timing START ##	===============//(20211022)
    _INIT_DCS_CMD(0x00, 0x80),
    _INIT_DCS_CMD(0xC0, 0x00,0x96,0x01,0x09,0x00,0x17),

    _INIT_DCS_CMD(0x00, 0x90),
    _INIT_DCS_CMD(0xC0, 0x00,0x96,0x01,0x09,0x00,0x17),

    _INIT_DCS_CMD(0x00, 0xA0),
    _INIT_DCS_CMD(0xC0, 0x01,0x27,0x01,0x10,0x00,0x10),

    _INIT_DCS_CMD(0x00, 0xB0),
    _INIT_DCS_CMD(0xC0, 0x00,0x96,0x01,0x09,0x17),
    ...
    _INIT_DCS_CMD(0x00, 0xB0),
    _INIT_DCS_CMD(0xCF, 0x06,0x06,0x40,0x44),
...
//VGHO1 & VGLO1
    _INIT_DCS_CMD(0x00,0xB6),
    _INIT_DCS_CMD(0xC5,0x75,0x75),   //M_VGHO1_N_I 19V

    _INIT_DCS_CMD(0x00,0xB8),
    _INIT_DCS_CMD(0xC5,0x39,0x39),  //M_VGLO1_N_I -11V

//master vcom on
    _INIT_DCS_CMD(0x00,0x91),
    _INIT_DCS_CMD(0xA5,0x00),

//VGHO1 off setting GND
    _INIT_DCS_CMD(0x00,0xB0),
    _INIT_DCS_CMD(0xC5,0x00),

//VGLO1 off setting GND
...
//VGHO1 & VGLO1 -2step
    _INIT_DCS_CMD(0x00,0xB6),
    _INIT_DCS_CMD(0xC5,0x73,0x73),   //S_VGHO1_N_I 18.8V

    _INIT_DCS_CMD(0x00,0xB8),
    _INIT_DCS_CMD(0xC5,0x37,0x37),  //S_VGLO1_N_I -10.8V

//slave vcom off
    _INIT_DCS_CMD(0x00,0x91),
    _INIT_DCS_CMD(0xA5,0x40),

//VGHO1 off setting HiZ
    _INIT_DCS_CMD(0x00,0xB0),
    _INIT_DCS_CMD(0xC5,0x41),

//VGLO1 off setting HiZ
    _INIT_DCS_CMD(0x00,0xB3),
    _INIT_DCS_CMD(0xC5,0x41),
...
//2022 0608  ÐÂÔö¸Ä½øºáÎÆ
    _INIT_DCS_CMD(0x00,0x90),//2022 0608
    _INIT_DCS_CMD(0xE9,0x10),//2022 0608
		
//cabc 12bit 29k dimming32frame
    _INIT_DCS_CMD(0x00,0xB0),
    _INIT_DCS_CMD(0xCA,0x00,0x00,0x04,0x00,0x06),
...
struct cust_drm_lcm m100t_ft8201ab_jttd_jpf105u001_wuxga = {
	.name = "m100t_ft8201ab_jttd_jpf105u001_wuxga",
