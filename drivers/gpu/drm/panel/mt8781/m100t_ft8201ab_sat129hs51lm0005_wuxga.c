...
//_INIT_DCS_CMD(0x00,0xB0), //PWM 12bit 29.3Khz Dimming 25frame
//_INIT_DCS_CMD(0xCA,0x00,0x00,0x04,0x00,0x05),
...
_INIT_DCS_CMD(0x00,0x00), 
_INIT_DCS_CMD(0xD8,0xBE,0xBE),  //GVDDP/N CD==5.4V

_INIT_DCS_CMD(0x00,0x00), 
_INIT_DCS_CMD(0xD9,0x00,0x80,0x80),  //VCOM(-1V) 
...
//Analog Gamma 
_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xE1,0x05,0x14,0x2F,0x44,0x50,0x5B,0x6D,0x7A,0x7A,0x86,0x85,0x96,0x71,0x61,0x63,0x58),
_INIT_DCS_CMD(0x00,0x10),
_INIT_DCS_CMD(0xE1,0x50,0x45,0x36,0x2E,0x25,0x15,0x02,0x00),

_INIT_DCS_CMD(0x00,0x00),
_INIT_DCS_CMD(0xE2,0x05,0x14,0x2F,0x44,0x50,0x5B,0x6D,0x7A,0x7A,0x86,0x85,0x96,0x71,0x61,0x63,0x58),
_INIT_DCS_CMD(0x00,0x10),
_INIT_DCS_CMD(0xE2,0x50,0x45,0x36,0x2E,0x25,0x15,0x02,0x00),
...
_INIT_DCS_CMD(0xC2,0x85,0x03,0x78,0x9D),
...
_INIT_DCS_CMD(0xC2,0x84,0x03,0x78,0x9D), 

//VEND5        (20200812)

_INIT_DCS_CMD(0x00,0xB0),

_INIT_DCS_CMD(0xC2,0x01,0x43,0x78,0x9D),

//VEND6        (20200812)

_INIT_DCS_CMD(0x00,0xB4),

_INIT_DCS_CMD(0xC2,0x00,0x03,0x78,0x9D),

//CLKC
_INIT_DCS_CMD(0x00,0x80),

_INIT_DCS_CMD(0xC3,0x83,0x87,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0x88),

_INIT_DCS_CMD(0xC3,0x81,0x85,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0x90),

_INIT_DCS_CMD(0xC3,0x01,0x83,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0x98),

_INIT_DCS_CMD(0xC3,0x03,0x81,0x03,0x7C,0xB2,0x00,0x02,0x07),          

//CLKD
_INIT_DCS_CMD(0x00,0xC0),

_INIT_DCS_CMD(0xCD,0x82,0x86,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0xC8),

_INIT_DCS_CMD(0xCD,0x00,0x84,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0xD0),

_INIT_DCS_CMD(0xCD,0x02,0x82,0x03,0x7C,0xB2,0x00,0x02,0x07),

_INIT_DCS_CMD(0x00,0xD8),

_INIT_DCS_CMD(0xCD,0x04,0x80,0x03,0x7C,0xB2,0x00,0x02,0x07),
...
_INIT_DCS_CMD(0x00, 0x80),
_INIT_DCS_CMD(0xC0, 0x00 ,0x98 ,0x00 ,0xFF ,0x00 ,0x10),

_INIT_DCS_CMD(0x00, 0x90),
_INIT_DCS_CMD(0xC0, 0x00 ,0x98 ,0x00 ,0xFF ,0x00 ,0x10),

_INIT_DCS_CMD(0x00, 0xA0),
_INIT_DCS_CMD(0xC0, 0x01 ,0x30 ,0x00 ,0xFF ,0x00 ,0x10),

_INIT_DCS_CMD(0x00, 0xB0),
_INIT_DCS_CMD(0xC0, 0x00 ,0x98 ,0x00 ,0xFF ,0x10),

_INIT_DCS_CMD(0x00, 0xA3),
_INIT_DCS_CMD(0xC1, 0x1A, 0x1A, 0x04),

_INIT_DCS_CMD(0x00, 0x80),
_INIT_DCS_CMD(0xCE, 0x00 ),

_INIT_DCS_CMD(0x00, 0xD0),
_INIT_DCS_CMD(0xCE, 0x01 ,0x00 ,0x0A ,0x01 ,0x01 ,0x00 ,0xEC ,0x00),
...
_INIT_DCS_CMD(0x00, 0xC0),
_INIT_DCS_CMD(0xCF, 0x07 ,0x07 ,0x4C ,0x50),
...
//tp term VGH pump off CLK gating
_INIT_DCS_CMD(0x00,0x94), 
_INIT_DCS_CMD(0xC5,0x46),  //N_VGH_Pump_CLK_Freq[2:0]:4Line

_INIT_DCS_CMD(0x00,0x98),
_INIT_DCS_CMD(0xC5,0x64),//I_VGH_Pump_CLK_Freq[6:4]: 4Line

_INIT_DCS_CMD(0x00,0x9B), 
_INIT_DCS_CMD(0xC5,0x65),  //N_VGL_Pump_CLK_Freq[6:4]:4Line

_INIT_DCS_CMD(0x00,0x9D), 
_INIT_DCS_CMD(0xC5,0x65),  //I_VGL_Pump_CLK_Freq[6:4]:4Line
...
struct cust_drm_lcm m100t_ft8201ab_sat129hs51lm0005_wuxga = {
	.name = "m100t_ft8201ab_sat129hs51lm0005_wuxga",
