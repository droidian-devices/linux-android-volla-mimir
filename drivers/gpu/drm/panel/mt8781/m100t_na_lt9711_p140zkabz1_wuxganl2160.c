...
#ifdef LCM_140
#define WIDTH_MM    296
#define HEIGHT_MM   197
#endif

#ifdef LCM_156
#define WIDTH_MM    194
#define HEIGHT_MM   344
#endif

#ifdef LCM_150
#define WIDTH_MM    318
#define HEIGHT_MM   211
#endif
...
#define LCM_WIDTH       2160
#define LCM_HEIGHT      1440
...
static int common_panel_unprepare_power(struct drm_panel *panel)
{
    ...
    cust_gpio_set_value(CUST_GPIO_LCM_BL_EN, GPIO_OUT_ZERO);
    mdelay(5);

    cust_gpio_set_value(CUST_GPIO_LCM_RST, GPIO_OUT_ZERO);
    mdelay(5);

    cust_gpio_set_value(CUST_GPIO_IT6112_EN, GPIO_OUT_ZERO);//edp_1v8
    msleep(5);

	cust_gpio_set_value(CUST_GPIO_BIAS_NEG, GPIO_OUT_ZERO);//edp_1v2
	mdelay(5);

    cust_gpio_set_value(CUST_GPIO_BIAS_POS, GPIO_OUT_ZERO);//edp_3v3
    mdelay(5);
...
struct cust_drm_lcm m100t_na_lt9711_p140zkabz1_wuxganl2160 = {
	.name = "m100t_na_lt9711_p140zkabz1_wuxganl2160",
