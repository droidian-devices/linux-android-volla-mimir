...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0xC3,0x2A), 
	_INIT_DCS_CMD(0xE7,0x2A), 
	_INIT_DCS_CMD(0xC5,0x2A), 
	_INIT_DCS_CMD(0xDE,0x2A), 
					   
	_INIT_DCS_CMD(0xB0,0x00), 
	_INIT_DCS_CMD(0xB6,0x02), 
	_INIT_DCS_CMD(0xBA,0x8B), 
	_INIT_DCS_CMD(0xBD,0x6E), 
	_INIT_DCS_CMD(0xBF,0x15), 
	...
	_INIT_DCS_CMD(0xD5,0x20), 
	_INIT_DCS_CMD(0xC0,0x00), 
	
	//gamma2.2
	_INIT_DCS_CMD(0xB0,0x02), 
	_INIT_DCS_CMD(0xC0,0x00), 
	_INIT_DCS_CMD(0xC1,0x09), 
	_INIT_DCS_CMD(0xC2,0x13), 
	_INIT_DCS_CMD(0xC3,0x22), 
	_INIT_DCS_CMD(0xC4,0x27), 
	_INIT_DCS_CMD(0xC5,0x2A), 
	_INIT_DCS_CMD(0xC6,0x2B), 
	_INIT_DCS_CMD(0xC7,0x2C), 
	_INIT_DCS_CMD(0xC8,0x2D), 
	_INIT_DCS_CMD(0xC9,0x2D), 
	_INIT_DCS_CMD(0xCA,0x2F), 
	_INIT_DCS_CMD(0xCB,0x30), 
	_INIT_DCS_CMD(0xCC,0x33), 
	_INIT_DCS_CMD(0xCD,0x2A), 
	_INIT_DCS_CMD(0xCE,0x2B), 
	_INIT_DCS_CMD(0xCF,0x2C), 
	_INIT_DCS_CMD(0xD0,0x07), 
	_INIT_DCS_CMD(0xD0,0x00), 
	_INIT_DCS_CMD(0xD2,0x00), 
	_INIT_DCS_CMD(0xD3,0x09), 
	_INIT_DCS_CMD(0xD4,0x13), 
	_INIT_DCS_CMD(0xD5,0x22), 
	_INIT_DCS_CMD(0xD6,0x27), 
	_INIT_DCS_CMD(0xD7,0x2A), 
	_INIT_DCS_CMD(0xD8,0x2B), 
	_INIT_DCS_CMD(0xD9,0x2C), 
	_INIT_DCS_CMD(0xDA,0x2D), 
	_INIT_DCS_CMD(0xDB,0x2D), 
	_INIT_DCS_CMD(0xDC,0x2F), 
	_INIT_DCS_CMD(0xDD,0x30), 
	_INIT_DCS_CMD(0xDE,0x33), 
	_INIT_DCS_CMD(0xDF,0x2A), 
	_INIT_DCS_CMD(0xE0,0x2B), 
	_INIT_DCS_CMD(0xE1,0x2C), 
	_INIT_DCS_CMD(0xE2,0x07), 
	
	_INIT_DCS_CMD(0xB0,0x04),  
	_INIT_DCS_CMD(0xB5,0x02),  
	_INIT_DCS_CMD(0xB6,0x01),  
...
struct cust_drm_lcm m100t_k080mm2b803_wuxga_8 = {
	.name = "m100t_k080mm2b803_wuxga_8",
