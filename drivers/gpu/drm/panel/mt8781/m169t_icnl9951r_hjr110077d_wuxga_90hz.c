...
#if IS_ENABLED(CONFIG_WB_TOUCH_I2C_SUSPEND_LOW) //Leo 20240613
	cust_i2c_pull_down();
#endif
...
struct cust_drm_lcm m169t_icnl9951r_hjr110077d_wuxga_90hz = {
	.name = "m169t_icnl9951r_hjr110077d_wuxga_90hz",
