...
static const struct panel_init_cmd cm_init_cmd[] = {
    ...
    _INIT_DCS_CMD(0xB1,0x2C,0xB1,0xB1,0x2D,0xED,0x32,0xD7,0x43,0x36,0x36,0x36,0x36),
    _INIT_DCS_CMD(0xE9,0xD9),
    _INIT_DCS_CMD(0xB1,0x78,0x33),
    _INIT_DCS_CMD(0xE9,0x3F),
    _INIT_DCS_CMD(0xB2,0x00,0x47,0xB0,0xD0,0x00,0x12,0x72,0x3C,0x9B,0x22,0x02,0x02,0x00,0x88,0xF0),
    _INIT_DCS_CMD(0xB3,0x11),
    _INIT_DCS_CMD(0xB4,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x6A,0x4D,0x6A,0x4D,0x01,0x95),
    ...
    _INIT_DCS_CMD(0xC0,0x32,0x32,0x22,0x11,0x33,0xA0,0x61,0x08,0xF5,0x03),
    ...
    _INIT_DCS_CMD(0xCB,0x08,0x13,0x07,0x00,0x0E,0xA1),
    ...
    _INIT_DCS_CMD(0xD3,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x6B,0x03,0xAA,0xAB,0x0E,0x0E,0x03,0x03,0x98,0x10,0x08,0x00,0x08,0x32,0x17,0xDE,0x07,0xDE,0x32,0x17,0xE2,0x07,0xE2,0x00,0x00),
    _INIT_DCS_CMD(0xD5,0x18,0x18,0x18,0x18,0x18,0x18,0x48,0x48,0x18,0x18,0x18,0x18,0x22,0x23,0x1F,0x1F,0x1E,0x1E,0x24,0x25,0x26,0x27,0x28,0x29,0x2A,0x2B,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x20,0x21,0x18,0x18,0x18,0x18),
    _INIT_DCS_CMD(0xD8,0x00,0xAA,0xAA,0xAA,0xAA,0x00,0x00,0xAA,0xAA,0xAA,0xAA,0x00,0x00,0xAA,0xEA,0xAA,0xAA,0x00,0x00,0xAA,0xEA,0xAA,0xAA,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00),
    _INIT_DCS_CMD(0xE0,0x00,0x02,0x08,0x0D,0x12,0x18,0x2C,0x32,0x38,0x34,0x4F,0x56,0x5E,0x70,0x72,0x7E,0x89,0x9E,0x9F,0x50,0x59,0x62,0x68,0x00,0x02,0x08,0x0D,0x12,0x18,0x2C,0x32,0x38,0x34,0x4F,0x56,0x5E,0x70,0x72,0x7E,0x89,0x9E,0x9F,0x50,0x59,0x65,0x74),
    _INIT_DCS_CMD(0xE7,0x08,0x10,0x10,0x1B,0x22,0x95,0x01,0x5C,0x97,0x14,0x14,0x00,0x00,0x00,0x00,0x12,0x05,0x02,0x02,0x10,0x33,0x02,0x04,0x18,0x01),
    ...
    _INIT_DCS_CMD(0xD2,0x3C),
    _INIT_DCS_CMD(0xE9,0xC5),
    _INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x80,0x80,0x0C,0xA1),
    _INIT_DCS_CMD(0xE9,0x3F),
    _INIT_DCS_CMD(0xD8,0x00,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0xFF,0xFF,0xFF,0xFF),
    _INIT_DCS_CMD(0xE7,0x02,0x00,0x3E,0x01,0x83,0x0F,0x7E,0x10,0xA0,0x00,0x00),
    ...
    _INIT_DCS_CMD(0xE9,0xCC),
    _INIT_DCS_CMD(0xD3,0x02,0x1D,0xE0,0x11,0x70),
    _INIT_DCS_CMD(0xE9,0x3F),
    _INIT_DCS_CMD(0xD8,0xAB,0xFF,0xFF,0xFF,0xFF,0xA0,0xAB,0xFF,0xFF,0xFF,0xFF,0xA0),
    _INIT_DCS_CMD(0xE7,0xFB,0x01,0xFB,0x01,0xFB,0x01,0x00,0x00,0x00,0x26,0x00,0x26,0x81,0x02,0x40,0x00,0x20,0x94,0x05,0x04,0x03,0x02,0x01,0x00,0x00,0x00,0x01,0x00),
    _INIT_DCS_CMD(0xBD,0x03),
    _INIT_DCS_CMD(0xE9,0xC6),
    _INIT_DCS_CMD(0xB4,0x03,0xFF,0xF0),
    _INIT_DCS_CMD(0xE9,0x3F),
    _INIT_DCS_CMD(0xC1,0x00,0x04,0x08,0x0C,0x10,0x14,0x18,0x1C,0x1F,0x24,0x28,0x2B,0x2F,0x33,0x38,0x3C,0x3F,0x43,0x47,0x4B,0x53,0x5B,0x62,0x6A,0x73,0x7B,0x82,0x8A,0x92,0x9A,0xA2,0xA9,0xB2,0xBA,0xC3,0xCB,0xD3,0xDB,0xE4,0xEB,0xF3,0xF8,0xFA,0xFC,0xFE,0xFF,0x11,0x90,0xC3,0xA0,0xFF,0xDB,0x0D,0x7B,0x72,0xA2,0xC0,0x00),
    _INIT_DCS_CMD(0xD8,0xAA,0xBB,0xEA,0xAA,0xAA,0xA0,0xAA,0xBB,0xEA,0xAA,0xAA,0xA0,0xAB,0xFF,0xFF,0xFF,0xFF,0xA0,0xAB,0xFF,0xFF,0xFF,0xFF,0xA0,0xAA,0xBA,0xAA,0xAA,0xAA,0xA0,0xAA,0xBA,0xAA,0xAA,0xAA,0xA0),
...
struct cust_drm_lcm m100t_hx83102_xy_2082109qfh036002_wuxga2000 = {
	.name = "m100t_hx83102_xy_2082109qfh036002_wuxga2000",
