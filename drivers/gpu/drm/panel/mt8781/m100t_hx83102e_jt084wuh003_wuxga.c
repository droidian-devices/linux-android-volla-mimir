...
extern bool cust_mid_get_tp_gesture_state(void);
#endif
...
static const struct panel_init_cmd cm_init_cmd[] = {
	...
	_INIT_DCS_CMD(0xE1,0x04,0x00),//20240401,change DD initial code version VD0->V01->V02->V03->V04
	...
	_INIT_DCS_CMD(0xB1,0x10,0xFA,0xAF,0xAF,0x2D,0x2D,0xB2,0x61,0x4D,0x36,0x36,0x36,0x36,0x22,0x21,0x15,0x00),
	_INIT_DCS_CMD(0xB2,0x00,0xB0,0x47,0x80,0x00,0x14,0xC8,0x30,0x10,0x10,0x00,0x00,0x15,0x20,0x57),
	_INIT_DCS_CMD(0xB4,0xA4,0x88,0xA4,0x88,0xA4,0x88,0x68,0x50,0x01,0xB4,0x01,0x58,0x00,0xFF,0x00,0xFF),
	//B6,0x22,0x22,0xE3,0x04,0x00
	_INIT_DCS_CMD(0xBF,0xFC,0x85,0x80),
	_INIT_DCS_CMD(0xD2,0x2D,0x2D),
	_INIT_DCS_CMD(0xD3,0x00,0x00,0x00,0x00,0x01,0x04,0x00,0x08,0x08,0x37,0x37,0x33,0x3F,0x10,0x10,0x04,0x04,0x32,0x10,0x0C,0x00,0x0C,0x32,0x10,0x08,0x00,0x08,0x32,0x17,0x9B,0x07,0x9B,0x00,0x00,0x0E,0x1B,0x01,0x00,0x21,0x38,0x01,0x55,0x0F),
	//E0,0x00,0x06,0x0F,0x17,0x1F,0x36,0x4E,0x56,0x5D,0x5A,0x75,0x7D,0x82,0x90,0x8D,0x97,0xA4,0xB6,0xB5,0x58,0x5F,0x69,0x73,0x00,0x06,0x0F,0x17,0x1F,0x36,0x4E,0x56,0x5D,0x5A,0x75,0x7D,0x86,0x98,0x99,0xA0,0xA4,0xB6,0xB5,0x58,0x5F,0x69,0x73
	//E0,0x00,0x09,0x16,0x20,0x2C,0x4E,0x65,0x6B,0x71,0x6C,0x85,0x89,0x8C,0x99,0x96,0xA1,0xAC,0xBC,0xBA,0x5B,0x62,0x6B,0x73,0x00,0x09,0x16,0x20,0x2C,0x4E,0x65,0x6B,0x71,0x6C,0x85,0x8B,0x92,0xA3,0xA1,0xA6,0xAC,0xBC,0xBA,0x5B,0x62,0x6B,0x73
	_INIT_DCS_CMD(0xE0,0x00,0x06,0x11,0x19,0x21,0x3E,0x58,0x61,0x69,0x66,0x81,0x86,0x8A,0x98,0x94,0x9E,0xA9,0xBA,0xB7,0x59,0x60,0x6A,0x73,0x00,0x06,0x11,0x19,0x21,0x3E,0x58,0x61,0x69,0x66,0x81,0x87,0x8F,0xA1,0xA0,0xA4,0xA9,0xBA,0xB7,0x59,0x60,0x6A,0x73),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xB1,0x01,0x9B,0x21,0x3D),
	_INIT_DCS_CMD(0xD3,0x01,0x00,0xFC,0x00,0x00,0x11,0x10,0x00,0x0E),
	_INIT_DCS_CMD(0xCB,0x80,0x36,0x12,0x16,0xC0,0x28,0x40,0x84,0x22),
	...
	_INIT_DCS_CMD(0xD5,0x03,0x02,0x03,0x02,0x18,0x18,0x18,0x18,0x19,0x19,0x19,0x19,0x38,0x38,0x38,0x38,0x24,0x24,0x24,0x24,0x18,0x18,0x18,0x18,0x01,0x00,0x01,0x00,0x07,0x06,0x07,0x06,0x05,0x04,0x05,0x04,0x23,0x22,0x23,0x22,0x21,0x20,0x21,0x20),
	_INIT_DCS_CMD(0xD6,0x04,0x05,0x04,0x05,0x18,0x18,0x18,0x18,0x19,0x19,0x19,0x19,0x18,0x18,0x18,0x18,0x24,0x24,0x24,0x24,0x38,0x38,0x38,0x38,0x06,0x07,0x06,0x07,0x00,0x01,0x00,0x01,0x02,0x03,0x02,0x03,0x20,0x21,0x20,0x21,0x22,0x23,0x22,0x23),
	_INIT_DCS_CMD(0xE7,0x12,0x13,0x02,0x02,0x2B,0x2B,0x0E,0x0E,0x00,0x14,0x28,0x79,0x1A,0x78,0x01,0x01,0x00,0x00,0x00,0x00,0x17,0x00,0x68),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xE7,0x01,0x24,0x01,0x8F,0x0D,0xB2,0x0E),
	_INIT_DCS_CMD(0xBD,0x02),
	...
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0,0xAA,0xAA,0xAA,0xAA,0xAA,0xA0),
	_INIT_DCS_CMD(0xBD,0x01),
	_INIT_DCS_CMD(0xD8,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0,0x55,0x55,0x55,0x55,0x55,0x50,0x55,0x55,0x55,0x55,0x55,0x50),
	_INIT_DCS_CMD(0xBD,0x02),
	_INIT_DCS_CMD(0xD8,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0),
	_INIT_DCS_CMD(0xBD,0x03),
	_INIT_DCS_CMD(0xD8,0xAA,0xAA,0xFA,0xAA,0xAA,0xA0,0xAA,0xAA,0xFA,0xAA,0xAA,0xA0,0xAA,0xAA,0xFA,0xAA,0xAA,0xA0,0xAA,0xAA,0xFA,0xAA,0xAA,0xA0),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xCC,0x02),
	_INIT_DCS_CMD(0xBD,0x00),
	_INIT_DCS_CMD(0xBA,0x70,0x03,0xA8,0x83,0xF2,0x80,0x00,0x0D),
	_INIT_DCS_CMD(0xBD,0x03),
...
static int common_panel_unprepare_power(struct drm_panel *panel)
{
...
#if IS_ENABLED(CONFIG_CM_MIDMISC_SUPPORT)
	if(cust_mid_get_tp_gesture_state()){
    ...
    cust_gpio_set_ext_value("hmx_reset_gpio", GPIO_OUT_ZERO);
    mdelay(5);
#endif
...
#if IS_ENABLED(CONFIG_CM_CUST_GPIOS_EXT_SUPPORT)
    cust_gpio_set_ext_value("hmx_reset_gpio", GPIO_OUT_ONE);
    mdelay(5);
#endif
...
struct cust_drm_lcm m100t_hx83102e_jt084wuh003_wuxga = {
	.name = "m100t_hx83102e_jt084wuh003_wuxga",
