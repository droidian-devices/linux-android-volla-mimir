 ...
 *
 ****************************************************************************/
#ifndef __GC6153MIPI_SENSOR_H__
#define __GC6153MIPI_SENSOR_H__


/* SENSOR MIRROR FLIP INFO */
#define GC6153_MIRROR_NORMAL    1
#define GC6153_MIRROR_H         0
#define GC6153_MIRROR_V         0
#define GC6153_MIRROR_HV        0

#if GC6153_MIRROR_NORMAL
#define GC6153_MIRROR	        0x80
#elif GC6153_MIRROR_H
#define GC6153_MIRROR	        0x81
#elif GC6153_MIRROR_V
#define GC6153_MIRROR	        0x82
#elif GC6153_MIRROR_HV
#define GC6153_MIRROR	        0x83
#else
#define GC6153_MIRROR	        0x80
#endif
...
#define GC6153_MIRROR_1                     ((csci_integer("camera.mirror.support", 0) > 0) ? \
                                                 (csci_exist("gc6153.mirror") ? \
                                                    (0x80 | (csci_integer("gc6153.mirror", 0) & 0x03)) : GC6153_MIRROR) : GC6153_MIRROR)
#endif


/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define GC6153_SENSOR_GAIN_BASE             0x400
#define GC6153_SENSOR_GAIN_MAX              (12 * GC6153_SENSOR_GAIN_BASE)
#define GC6153_SENSOR_GAIN_MAX_VALID_INDEX  16
#define GC6153_SENSOR_GAIN_MAP_SIZE         16
#define GC6153_SENSOR_DGAIN_BASE            0x400
