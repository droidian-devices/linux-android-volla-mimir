...
static struct imgsensor_info_struct imgsensor_info = { 
    .sensor_id = HI545_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint16 hi545_table_write_cmos_sensor(
...
static void write_shutter(kal_uint32 shutter)
{
	...
	write_cmos_sensor(0x0004,shutter & 0x00FFFF);	 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi545[] = {
	//--- SRAM timing control---//
	0x0E00, 0x0101,
	0x0E02, 0x0101,
	0x0E04, 0x0101,
	...
	0x0138, 0x0004, //pxl_drv_pwr
	0x013A, 0x0100, //tx_idle
	0x0C00, 0x3BC1, //BLC_ctl1. Line BLC on = 0x3b, off = 0x2A //LBLC_ctl1. [0]en_blc, [1]en_lblc_dpc, [2]en_channel_blc, [3]en_adj_pxl_dpc, [4]en_adp_dead_pxl_th
	...
	0x0012, 0x00A4, //x_addr_start_hact_h. 164
	0x0018, 0x0AD1, //x_addr_end_hact_h. 2769. 2769-164+1=2606
	...
	0x0026, 0x0012, //y_addr_start_vact_h. 18
	0x002C, 0x07B5, //y_addr_end_vact_h.  1973. 1973-18+1=1956
	0x0034, 0x0700, //Y_region_sel
	//------------------------------//
	//--Crop size 2604x1956 ----///
	0x0128, 0x0002, // digital_crop_x_offset_l
	0x012A, 0x0000, // digital_crop_y_offset_l
	0x012C, 0x0A2C, // digital_crop_image_width  2604
	0x012E, 0x07A4, // digital_crop_image_height 1956
	//------------------------------//
	//----< Image FMT Size >--------------------//
	//Image size 2604x1956
	0x0110, 0x0A2C, //X_output_size_h     
	0x0112, 0x07A4, //Y_output_size_h     
	//------------------------------------------//
	//----< Frame / Line Length >--------------//
	...
	0x0000, 0x0300, //orientation. [0]:x-flip, [1]:y-flip.
	...
	0x0004, 0x04b0, //coarse_int : 33.33ms@Pclk88mhz@Line_length2880
...
{
  #if MULTI_WRITE
hi545_table_write_cmos_sensor(
	addr_data_pair_init_hi545,
	sizeof(addr_data_pair_init_hi545) /
	sizeof(kal_uint16));
#else
	LOG_INF("E");
	//////////////////////////////////////////////////////////////////////////
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi545[] = {
	//--- SREG ---//
	0x0B02, 0x0014, //140718
	0x0B16, 0x4A8B, //140718 sys_clk 1/2
	0x0B18, 0x0000, //140718
	0x0B1A, 0x1044, //140718
	0x004C, 0x0100, 
	0x000C, 0x0000, 

	//---< mipi time >---//
	0x0902, 0x4101, //mipi_value_clk_trail.  
	0x090A, 0x01E4, //mipi_vblank_delay_h.
	0x090C, 0x0005, //mipi_hblank_short_delay_h.
	0x090E, 0x0100, //mipi_hblank_long_delay_h.
	0x0910, 0x5D04, //05 mipi_LPX
	0x0912, 0x030f, //05 mipi_CLK_prepare
	0x0914, 0x0204, //02 mipi_clk_pre
	0x0916, 0x0707, //09 mipi_data_zero
	0x0918, 0x0f04, //0c mipi_clk_post

	//---< Pixel Array Address >------//
	0x0012, 0x00AA, //x_addr_start_hact_h. 170
	0x0018, 0x0ACB, //x_addr_end_hact_h. 2763 . 2763-170+1=2594
	0x0026, 0x0018, //y_addr_start_vact_h. 24
	0x002C, 0x07AF, //y_addr_end_vact_h.   1967. 1967-24+1=1944
	...
	//---< Frame/Line Length >-----//
//	0x0006, 0x07e1, //frame_length_h 2017
//	0x0008, 0x0B40, //line_length_h 2880
	0x000A, 0x0DB0, 

	//---< ETC set >---------------//
//	0x0000, 0x0100, //orientation. [0]:x-flip, [1]:y-flip.
	0x0700, 0xA0A8, //140718 scaler 1/2
	0x001E, 0x0101, //140718
	0x0032, 0x0101, //140718
	0x0A02, 0x0100, //140718 Fast sleep Enable
	0x0A04, 0x0133, //TEST PATTERN
...
#if MULTI_WRITE
		hi545_table_write_cmos_sensor(
			addr_data_pair_preview_hi545,
			sizeof(addr_data_pair_preview_hi545) /
			sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi545[] = {
		//--- SREG ---//
		0x0B02, 0x0014, //140718
		0x0B16, 0x4A0B, 
		0x0B18, 0x0000, //140718
		...
		0x0128, 0x0002, //digital_crop_x_offset_l  
		0x012A, 0x0000, //digital_crop_y_offset_l  
		0x012C, 0x0A20, //2592 digital_crop_image_width 
		0x012E, 0x0798, //1944 digital_crop_image_height 
		...
		//---< ETC set >---------------//
//		0x0000, 0x0100, //orientation. [0]:x-flip, [1]:y-flip.
		0x0700, 0x0590, //140718
		0x001E, 0x0101, //140718
		0x0032, 0x0101, //140718
		0x0A02, 0x0100, //140718 Fast sleep Enable
		0x0A04, 0x011B, //TEST PATTERN enable

    };

kal_uint16 addr_data_pair_capture_30fps_hi545[] = {
		//--- SREG ---//
		0x0B02, 0x0014, //140718
		0x0B16, 0x4A0B, 
		0x0B18, 0x0000, //140718
...
static void capture_setting(kal_uint16 currefps)
{
		...
		if (currefps == 300) {
		hi545_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_hi545,
			sizeof(addr_data_pair_capture_30fps_hi545) /
			sizeof(kal_uint16));
		} else {
		hi545_table_write_cmos_sensor(
			addr_data_pair_capture_fps_hi545,
			sizeof(addr_data_pair_capture_fps_hi545) /
			sizeof(kal_uint16));
		}
#else
...
//#if MULTI_WRITE
//kal_uint16 addr_data_pair_hs_video_hi545[] = {
//
//
//
//	//--- SREG ---//
...
//
//	//---< Pixel Array Address >------//
//	0x0012, 0x00AA, //x_addr_start_hact_h.	// 164 + 6 = 170
//	0x0018, 0x0ACD, //x_addr_end_hact_h.	// 2771 - 6 = 2765 
//	0x0026, 0x0012, //y_addr_start_vact_h.	// 16 + 2 = 18 (0x12)
//	0x002C, 0x07B1, //y_addr_end_vact_h.	// 1971 - 2 = 1969 (0x7B1)
//
//	//---< Crop size : 648x488 >----//
//	0x0128, 0x0002, // digital_crop_x_offset_l
//	0x012A, 0x0000, // digital_crop_y_offset_l
//	0x012C, 0x0510, // digital_crop_image_width // 1296 (0x510)
//	0x012E, 0x01E8, // digital_crop_image_height // VGA = 488 (0x1E8)
//
//	//---< FMT Size : 648x488 >---------//
//	0x0110, 0x0288, //X_output_size_h	// 648
//	0x0112, 0x01E8, //Y_output_size_h	// 488
//
//	//---< Frame/Line Length >-----//
//	0x0006, 0x01FA, //frame_length_h 1984 - 1956 = 28 --> 488 + 18 = 506(0x1FA) for frame rate
//	0x0008, 0x0B40, //line_length_h 2880
//	0x000A, 0x0DB0, //line_length for binning 3504
//
//	//---< ETC set >---------------//
//	//	0x0000, 0x0000, 
//	0x0700, 0x215A, // Scaler b[7:6] r_byrscl_y_ratio, b[5:4] r_byrscl_x_ratio [ '01' 3/4 scale down, '10' 1/2 scale down]
//	0x001E, 0x0301, //140718
//	0x0032, 0x0701, //140718
//	0x0A02, 0x0100, //140718 Fast sleep Enable
//	0x0A04, 0x013B, //TEST PATTERN enable
//	};
//#endif
...
//#if MULTI_WRITE
//		hi545_table_write_cmos_sensor(
//			addr_data_pair_hs_video_hi545,
//			sizeof(addr_data_pair_hs_video_hi545) /
//			sizeof(kal_uint16));
//#else
//
//	LOG_INF("E\n");
...
//#if MULTI_WRITE
//kal_uint16 addr_data_pair_slim_video_hi545[] = {
//
//
//	//--- SREG ---//
//	0x0B02, 0x0014, //140718
...
//#if MULTI_WRITE
//		hi545_table_write_cmos_sensor(
//			addr_data_pair_slim_video_hi545,
//			sizeof(addr_data_pair_slim_video_hi545) /
//			sizeof(kal_uint16));
//#else
//
//	LOG_INF("E\n");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id =return_sensor_id();
                ...
                printk("chench hi545 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					return ERROR_NONE;
				}	
				printk("chench hi545 get_imgsensor_id Read sensor id fail, i2c write id: 0x%x,sensor id: 0x%x ,imgsensor_info.sensor_id :0x%x\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);
				retry--;
			} while(retry > 0);
			i++;
			retry = 2;
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: hi545 PLATFORM:MT6750,MIPI 24LANE\n");
	LOG_INF("hi545 preview 1296*972@30fps,360Mbps/lane; capture 2593*1944@30fps,880Mbps/lane\n");
	printk("[hi545 into open] ");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
		spin_unlock(&imgsensor_drv_lock);
		do {
			...
			printk("chench hi545 Open:Read sensor id fail open i2c write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		if (sensor_id == imgsensor_info.sensor_id)
...
enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	case MSDK_SCENARIO_ID_SLIM_VIDEO:
	    ...
	    spin_lock(&imgsensor_drv_lock);
	    imgsensor.dummy_line = (frame_length >
		imgsensor_info.slim_video.framelength) ? (frame_length -imgsensor_info.slim_video.framelength) : 0;
        imgsensor.frame_length =
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable)
		...
		write_cmos_sensor(0x0118, 0x0000);  //stream off
	mdelay(10);
	return ERROR_NONE;
}
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        ...
        *feature_para_len = 4;
        break;
		case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:   //第一个参数请回传1代表支持新版framesync，第二个参数回传margin值给AE/CCU使用
		/*
