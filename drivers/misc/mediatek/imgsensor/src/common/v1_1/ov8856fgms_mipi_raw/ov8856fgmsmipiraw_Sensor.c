...
#include "ov8856fgmsmipiraw_Sensor.h"

#define PFX "OV8856FGMS"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856FGMS_SENSOR_ID,
...
{
#if (IS_ENABLED(CONFIG_WB_BOARD_ID_SUPPORT) && IS_ENABLED(CONFIG_WB_DG_CUST_SUPPORT))//Leo 20230423//Leo 20230417
	if (cust_midmisc_get_board_id() == 1) {
		return OV8856FGMS_SENSOR_ID;
	} else {
		return ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C))+1;
	}
#else
		return ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C))+1;
#endif
...
kal_uint16 addr_data_pair_init_ov8856gms[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
{
	LOG_INF("v3 E\n");
	ov8856_table_write_cmos_sensor(addr_data_pair_init_ov8856gms,
	  sizeof(addr_data_pair_init_ov8856gms) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856gms[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov8856_table_write_cmos_sensor(addr_data_pair_preview_ov8856gms,
				   sizeof(addr_data_pair_preview_ov8856gms) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856gms[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856gms[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		...
		addr_data_pair_capture_15fps_ov8856gms,
	sizeof(addr_data_pair_capture_15fps_ov8856gms) / sizeof(kal_uint16));
	} else {
		ov8856_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov8856gms,
			       sizeof(addr_data_pair_capture_30fps_ov8856gms) /
			       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov8856gms[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366e, 0x08,
	0x3714, 0x29,
...
static void vga_setting_120fps(void)
{
	...
	ov8856_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov8856gms,
			sizeof(addr_data_pair_vga_setting_120fps_ov8856gms) /
			 sizeof(kal_uint16));
...
UINT32 OV8856FGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
