 ...
 *
 ****************************************************************************/
#ifndef _GC13A0MIPI_SENSOR_H
#define _GC13A0MIPI_SENSOR_H
...
#if defined(CONFIG_GC13A0_MIRROR_HV)
...
#define GC13A0_MIRROR_1                     ((csci_integer("camera.mirror.support", 0) > 0) ? ((csci_integer("gc13a0.mirror", 0) > 0) ? 0x03 : 0x00) : GC13A0_MIRROR)
#define GC13A0_PARA_1                  ((csci_integer("camera.mirror.support", 0) > 0) ? ((csci_integer("gc13a0.mirror", 0) > 0) ? 0x0e : 0x0d) : GC13A0_PARA)
#endif
