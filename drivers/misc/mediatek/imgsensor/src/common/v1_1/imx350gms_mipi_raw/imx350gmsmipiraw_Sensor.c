...
#if IS_ENABLED(CONFIG_CM_CUST_GPIOS_SUPPORT) //Leo 20230131
...
/*support ZHDR*/
/* #define imx350gms_ZHDR */

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static BYTE imx350gms_SPC_data[352] = { 0 };

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX350GMS_SENSOR_ID,
...
#define IMX350GMSMIPI_MaxGainIndex (389)
kal_uint16 imx350gmsMIPI_sensorGainMapping[IMX350GMSMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
...
static void imx350gms_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx350gms_get_pdaf_reg_setting(
...
static void imx350gms_set_pdaf_reg_setting(
	MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx350gms_apply_SPC(void)
{
	...
	imx350gms_read_SPC(imx350gms_SPC_data);

	tosend = 0;
	puSendCmd[tosend++] = (char)(start_reg >> 8);
	puSendCmd[tosend++] = (char)(start_reg & 0xFF);
	memcpy((void *)&puSendCmd[tosend], imx350gms_SPC_data, 352);
	tosend += 352;
...
static kal_uint32 return_lot_id_from_otp(void)
{
	 ...
	 */
#if IS_ENABLED(CONFIG_WB_BOARD_ID_SUPPORT)//Leo 20230423//Leo 20230417
	if (cust_midmisc_get_board_id() == 1) {
		return IMX350GMS_SENSOR_ID;
	} else {
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX350GMSMIPI_MaxGainIndex; iI++) {
		if (gain <= imx350gmsMIPI_sensorGainMapping[iI][0])
			return imx350gmsMIPI_sensorGainMapping[iI][1];
	}

	return imx350gmsMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx350gms_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_imx350gms_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx350gms_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx350gms_table_write_cmos_sensor(addr_data_pair_imx350gms_zvhdr_on,
		sizeof(addr_data_pair_imx350gms_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx350gms_table_write_cmos_sensor(addr_data_pair_imx350gms_zvhdr_off,
		sizeof(addr_data_pair_imx350gms_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;

}

kal_uint16 addr_data_pair_init_imx350gms[] = {
	0x0136, 0x18,
	0x0137, 0x00,
...
{
	LOG_INF("E\n");
	imx350gms_table_write_cmos_sensor(addr_data_pair_init_imx350gms,
		sizeof(addr_data_pair_init_imx350gms)/sizeof(kal_uint16));

	/*enable temperature sensor, TEMP_SEN_CTL:*/
	write_cmos_sensor(0x0138, 0x01);
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx350gms[] = {
	0x0100, 0x00,
...
{
	imx350gms_table_write_cmos_sensor(addr_data_pair_preview_imx350gms,
	sizeof(addr_data_pair_preview_imx350gms) / sizeof(kal_uint16));
	/* zvhdr_setting(); */
}				/*    preview_setting  */

kal_uint16 addr_data_pair_capture_imx350gms[] = {
	0x0100, 0x00,
/*24fps*/
#ifdef IMX350GMS_24_FPS
	0x0112, 0x0A,
...
kal_uint16 addr_data_pair_capture_imx350gms_pdaf_on[] = {
	/*PDAF*/
	/*PD_OUT_EN=1 */
	0x3E37, 0x01,
	/*AREA MODE */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx350gms_table_write_cmos_sensor(addr_data_pair_capture_imx350gms,
	sizeof(addr_data_pair_capture_imx350gms) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif

	if (imgsensor.pdaf_mode == 1) {
		imx350gms_table_write_cmos_sensor(
			addr_data_pair_capture_imx350gms_pdaf_on,

		sizeof(
		addr_data_pair_capture_imx350gms_pdaf_on) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_video_imx350gms[] = {
	0x0100, 0x00,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx350gms_table_write_cmos_sensor(addr_data_pair_video_imx350gms,
	sizeof(addr_data_pair_video_imx350gms) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
}

kal_uint16 addr_data_pair_hs_video_imx350gms[] = {
	0x0100, 0x00,
...
{
	imx350gms_table_write_cmos_sensor(addr_data_pair_hs_video_imx350gms,
	sizeof(addr_data_pair_hs_video_imx350gms) / sizeof(kal_uint16));
	zvhdr_setting();
}
...
static kal_uint32 open(void)
{
	...
	KD_SENSOR_PROFILE("imx350gms_open_1");
	...
	KD_SENSOR_PROFILE("imx350gms_open_2");
	return ERROR_NONE;
} /* open */
...
static kal_uint32 imx350gms_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx350gms_awb_gain(pSetSensorAWB);
		break;
