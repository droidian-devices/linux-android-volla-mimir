 ...
 *
 ****************************************************************************/
#ifndef _S5KJN1GMSMIPI_SENSOR_H
#define _S5KJN1GMSMIPI_SENSOR_H
...
typedef struct imgsensor_mode_struct {
	...
	kal_uint32 grabwindow_width;	//record different mode's width of grabwindow
	kal_uint32 grabwindow_height;	//record different mode's height of grabwindow
...
typedef struct imgsensor_info_struct {
	...
	imgsensor_mode_struct cap2;		//capture for PIP 15fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
