...
#define GC02M1_MIRROR_1                     ((csci_integer("camera.mirror.support", 0) > 0) ? \
                                                 (csci_exist("gc02m1.mirror") ? \
                                                    (0x80 | (csci_integer("gc02m1.mirror", 0) & 0x03)) : GC02M1_MIRROR) : GC02M1_MIRROR)
#endif
