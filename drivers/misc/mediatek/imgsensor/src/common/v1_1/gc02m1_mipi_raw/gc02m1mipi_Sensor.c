...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x6e, 0x6f,0x20, 0xff},
	.i2c_speed = 400,
};
...
static void sensor_init(void)
{
	...
	if (csci_integer("camera.mirror.support", 0) > 0) {
		if (csci_exist("gc02m1.mirror")) {
			write_cmos_sensor(0xf0, 0x00);
			write_cmos_sensor(0x17, GC02M1_MIRROR_1);
		}
	}
#endif
...
#if 0//IS_ENABLED(CONFIG_WB_IMGSENSOR_INDEX_SUPPORT) //Leo 20211108
