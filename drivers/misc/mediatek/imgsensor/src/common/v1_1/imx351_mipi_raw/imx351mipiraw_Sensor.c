...
{
{ 4656, 3496, 0, 0, 4656, 3496, 4656, 3496,	0000, 0000, 4656, 3496, 0, 0, 4656, 3496},	/* Preview */
{ 4656, 3496, 0, 0, 4656, 3496, 4656, 3496,	0000, 0000, 4656, 3496, 0, 0, 4656, 3496},	/* capture */
{ 4656, 3496, 0, 0, 4656, 3496, 4656, 3496,	0000, 0000, 4656, 3496, 0, 0, 4656, 3496}, // video
{ 4656, 3496, 0, 0, 4656, 3496, 4656, 3496,	0000, 0000, 4656, 3496, 0, 0, 4656, 3496}, //hight speed video
{ 4656, 3496, 0, 0, 4656, 3496, 4656, 3496,	0000, 0000, 4656, 3496, 0, 0, 4656, 3496},// slim video
};
...
#if IS_ENABLED(CONFIG_MID_CSCI_SUPPORT) //Leo 20220909
    if (csci_exist("camera.mirror.support.imx351")) {
        if (csci_integer("camera.mirror.support.imx351", 0) > 0) {
...
*
*************************************************************************/
#if 1//IS_ENABLED(CONFIG_WB_IMGSENSOR_INDEX_SUPPORT) //Leo 20211108
...
#if IS_ENABLED(CONFIG_MID_CSCI_SUPPORT) //Leo 20220909
    if (csci_exist("camera.output.dataformat.imx351")) {
        sensor_info->SensorOutputDataFormat = csci_integer("camera.output.dataformat.imx351", 0);
    }
#endif
