...
#include "gc05a2fmipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc05a2f_camera_sensor"
#define LOG_1 LOG_INF("GC05A2F, MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
#define GC05A2F_DEBUG                0
#if GC05A2F_DEBUG
...
//#if GC05A2F_MIRROR_NORMAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,
//#elif GC05A2F_MIRROR_H
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,
//#elif GC05A2F_MIRROR_V
//	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
//#elif GC05A2F_MIRROR_HV
...
kal_uint16 gc05a2f_init_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2f_1296x972_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2f_2592x1944_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static kal_uint16 gc05a2f_1280x720_addr_data[] = {
/*system*/
	0x0315, 0xd4,
	0x0d06, 0x01,
	0x0a70, 0x80,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc05a2f_init_addr_data,
		sizeof(gc05a2f_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(gc05a2f_1296x972_addr_data,
		sizeof(gc05a2f_1296x972_addr_data)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc05a2f_2592x1944_addr_data,
		sizeof(gc05a2f_2592x1944_addr_data)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] hs_video_Start, 1296x972@30.01fps\n", __func__);
	table_write_cmos_sensor(gc05a2f_1296x972_addr_data,
		sizeof(gc05a2f_1296x972_addr_data)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] slim_video_Start, 1280x720@60.03fps\n", __func__);
	table_write_cmos_sensor(gc05a2f_1280x720_addr_data,
		sizeof(gc05a2f_1280x720_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				printk("[gc05a2f_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			printk("[gc05a2f_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				printk("[gc05a2f_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			printk("[gc05a2f_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
UINT32 GC05A2F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
