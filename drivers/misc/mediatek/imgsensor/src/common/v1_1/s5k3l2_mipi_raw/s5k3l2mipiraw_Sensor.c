...
static imgsensor_info_struct imgsensor_info = {
    ...
    .mipi_sensor_type = 0, //0,MIPI_OPHY_NCSI2;  1,MIPI_OPHY_CSI2
    .mipi_settle_delay_mode = 1,//0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,	//Gr,
...
{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 0, 0, 1280, 720}, //hight speed video
{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 0, 0, 1280, 720},
};
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	break;
        default:
            break;//LOG_INF("Error image_mirror setting\n");
    }
...
static void sensor_init(void)
{
	...
	mDELAY(3);
  write_cmos_sensor1(0x6214, 0x7970);
  write_cmos_sensor1(0x6218, 0x7150);
  ...
  write_cmos_sensor1(0x6F12, 0xA436);
  write_cmos_sensor1(0x6028, 0xD000);
  write_cmos_sensor(0x3690, 0x01);
  write_cmos_sensor1(0x3692, 0x0060);
  write_cmos_sensor1(0x369A, 0xF446);
  write_cmos_sensor1(0x369C, 0x5176);
  write_cmos_sensor1(0x369E, 0x5C76);
  write_cmos_sensor1(0x36A0, 0x5C76);
  write_cmos_sensor1(0x36AE, 0xF40E);
  write_cmos_sensor1(0x36B0, 0x0B00);
  write_cmos_sensor1(0x36B2, 0x4B00);
  write_cmos_sensor1(0x36B4, 0x4B00);
  write_cmos_sensor1(0xF412, 0x0040);
  write_cmos_sensor1(0x3664, 0x0BB8);
  write_cmos_sensor1(0x35E4, 0x4776);
  write_cmos_sensor(0x3675, 0x76);
  write_cmos_sensor1(0x3672, 0x0520);
  write_cmos_sensor1(0x367A, 0x00ED);
  write_cmos_sensor(0x372A, 0x01);
  write_cmos_sensor1(0x3246, 0x0092);
  write_cmos_sensor1(0x324A, 0x009C);
  write_cmos_sensor1(0x3256, 0x01BD);
  write_cmos_sensor1(0x325A, 0x01C7);
  write_cmos_sensor1(0x3248, 0x0092);
  write_cmos_sensor1(0x324C, 0x009C);
  write_cmos_sensor1(0x3258, 0x01B2);
  write_cmos_sensor1(0x325C, 0x01BC);
  write_cmos_sensor1(0x3792, 0x0000);
  write_cmos_sensor1(0x3794, 0x0000);
  write_cmos_sensor1(0x3796, 0x0000);
  write_cmos_sensor1(0x379A, 0x0000);
  write_cmos_sensor1(0x379C, 0x0000);
  write_cmos_sensor1(0x379E, 0x0000);
  write_cmos_sensor1(0x33DA, 0x00BC);
  write_cmos_sensor1(0x33DC, 0x00BC);
  write_cmos_sensor1(0x33DE, 0x00BE);
  write_cmos_sensor1(0x33E0, 0x00BE);
  write_cmos_sensor1(0x33EA, 0x00BC);
  write_cmos_sensor1(0x33EC, 0x00BC);
  write_cmos_sensor1(0x33EE, 0x00D8);
  write_cmos_sensor1(0x33F0, 0x00D8);
  write_cmos_sensor1(0x36A2, 0x5176);
  write_cmos_sensor1(0x36A4, 0x2F76);
  write_cmos_sensor1(0x36A6, 0x2F76);
  write_cmos_sensor1(0x36B6, 0x0B00);
  write_cmos_sensor1(0x36B8, 0x4B00);
  write_cmos_sensor1(0x36BA, 0x4B00);
  write_cmos_sensor(0x372C, 0x48);
  write_cmos_sensor(0x372D, 0x48);
  write_cmos_sensor1(0x372E, 0x0002);
  write_cmos_sensor1(0x3730, 0x1106);
  write_cmos_sensor1(0x6028, 0x7000);
  ...
  write_cmos_sensor1(0x6F12, 0x0200);
  write_cmos_sensor1(0x6028, 0xD000);
  write_cmos_sensor1(0x0C00, 0x0100);
  write_cmos_sensor1(0x0C02, 0x01FF);
  write_cmos_sensor1(0x0C04, 0x0400);
  write_cmos_sensor1(0x0C06, 0x0438);
  write_cmos_sensor1(0x0C08, 0x0200);
  write_cmos_sensor1(0x0C0A, 0x03FF);
  write_cmos_sensor1(0x0C0C, 0x0415);
  write_cmos_sensor1(0x0C0E, 0x045B);
  write_cmos_sensor1(0x0C10, 0x0400);
  write_cmos_sensor1(0x0C12, 0x07FF);
  write_cmos_sensor1(0x0C14, 0x0421);
  write_cmos_sensor1(0x0C16, 0x043B);
  write_cmos_sensor1(0x0C18, 0x0800);
  write_cmos_sensor1(0x0C1A, 0x0FFF);
  write_cmos_sensor1(0x0C1C, 0x0423);
  write_cmos_sensor1(0x0C1E, 0x043B);
  write_cmos_sensor1(0x0C20, 0x1000);
  write_cmos_sensor1(0x0C22, 0x1FFF);
  write_cmos_sensor1(0x0C24, 0x0426);
  write_cmos_sensor1(0x0C26, 0x0426);
  write_cmos_sensor1(0x0B80, 0x0001);
  write_cmos_sensor1(0x0B86, 0x0020);
  write_cmos_sensor1(0x0B84, 0x0020);
  write_cmos_sensor1(0x0B82, 0x0003);
  write_cmos_sensor1(0x0B8C, 0x000A);
  write_cmos_sensor1(0x0B88, 0x0008);
  write_cmos_sensor1(0x0B96, 0x0005);
  write_cmos_sensor1(0x0B94, 0x0001);
  write_cmos_sensor1(0x0602, 0x03FF);
  write_cmos_sensor1(0x0604, 0x03FF);
  write_cmos_sensor1(0x0606, 0x03FF);
  write_cmos_sensor1(0x0608, 0x03FF);
  write_cmos_sensor1(0x3BE0, 0x03DA);
  write_cmos_sensor1(0x3BE2, 0x01D6);
  write_cmos_sensor1(0x3BE4, 0x01BF);
  write_cmos_sensor1(0x3BE6, 0x0001);
  write_cmos_sensor1(0x3BE8, 0x0003);
  write_cmos_sensor1(0x3BEA, 0x000A);
  write_cmos_sensor1(0x3BEC, 0x0022);
  write_cmos_sensor1(0x3BEE, 0x000A);
  write_cmos_sensor1(0x3BF0, 0x0022);
  write_cmos_sensor1(0x3BF2, 0x000A);
  write_cmos_sensor1(0x3BF4, 0x0022);
  write_cmos_sensor1(0x3BF6, 0x000A);
  write_cmos_sensor1(0x3BF8, 0x0022);
  write_cmos_sensor1(0x3BFA, 0x0001);
  write_cmos_sensor1(0x3BFC, 0x0003);
  write_cmos_sensor1(0x3BFE, 0x000A);
  write_cmos_sensor1(0x3C00, 0x0022);
  write_cmos_sensor1(0x3C02, 0x000A);
  write_cmos_sensor1(0x3C04, 0x0022);
  write_cmos_sensor1(0x3C06, 0x000A);
  write_cmos_sensor1(0x3C08, 0x0022);
  write_cmos_sensor1(0x3C0A, 0x000A);
  write_cmos_sensor1(0x3C0C, 0x0022);
  write_cmos_sensor1(0x3C0E, 0x0200);
  write_cmos_sensor1(0x3C10, 0x0200);
  write_cmos_sensor1(0x3C12, 0x0002);
  write_cmos_sensor1(0x3C14, 0x0003);
  write_cmos_sensor1(0x3C16, 0x0008);
  write_cmos_sensor1(0x3C18, 0x0018);
  write_cmos_sensor1(0x3C1A, 0x0008);
  write_cmos_sensor1(0x3C1C, 0x0018);
  write_cmos_sensor1(0x3C1E, 0x0008);
  write_cmos_sensor1(0x3C20, 0x0018);
  write_cmos_sensor1(0x3C22, 0x0008);
  write_cmos_sensor1(0x3C24, 0x0018);
  write_cmos_sensor1(0x3C26, 0x0002);
  write_cmos_sensor1(0x3C28, 0x0003);
  write_cmos_sensor1(0x3C2A, 0x0008);
  write_cmos_sensor1(0x3C2C, 0x0018);
  write_cmos_sensor1(0x3C2E, 0x0008);
  write_cmos_sensor1(0x3C30, 0x0018);
  write_cmos_sensor1(0x3C32, 0x0008);
  write_cmos_sensor1(0x3C34, 0x0018);
  write_cmos_sensor1(0x3C36, 0x0008);
  write_cmos_sensor1(0x3C38, 0x0018);
  write_cmos_sensor1(0x3C3A, 0x0200);
  write_cmos_sensor1(0x3C3C, 0x0200);
  write_cmos_sensor1(0x3C3E, 0x0002);
  write_cmos_sensor1(0x3C40, 0x0003);
  write_cmos_sensor1(0x3C42, 0x0014);
  write_cmos_sensor1(0x3C44, 0x0040);
  write_cmos_sensor1(0x3C46, 0x0014);
  write_cmos_sensor1(0x3C48, 0x0040);
  write_cmos_sensor1(0x3C4A, 0x0014);
  write_cmos_sensor1(0x3C4C, 0x0040);
  write_cmos_sensor1(0x3C4E, 0x0014);
  write_cmos_sensor1(0x3C50, 0x0040);
  write_cmos_sensor1(0x3C52, 0x0002);
  write_cmos_sensor1(0x3C54, 0x0003);
  write_cmos_sensor1(0x3C56, 0x0014);
  write_cmos_sensor1(0x3C58, 0x0040);
  write_cmos_sensor1(0x3C5A, 0x0014);
  write_cmos_sensor1(0x3C5C, 0x0040);
  write_cmos_sensor1(0x3C5E, 0x0014);
  write_cmos_sensor1(0x3C60, 0x0040);
  write_cmos_sensor1(0x3C62, 0x0014);
  write_cmos_sensor1(0x3C64, 0x0040);
  write_cmos_sensor1(0x3C66, 0x0200);
  write_cmos_sensor1(0x3C68, 0x0200);
  write_cmos_sensor1(0x3C6A, 0x0002);
  write_cmos_sensor1(0x3C6C, 0x0003);
  write_cmos_sensor1(0x3C6E, 0x0008);
  write_cmos_sensor1(0x3C70, 0x0018);
  write_cmos_sensor1(0x3C72, 0x0008);
  write_cmos_sensor1(0x3C74, 0x0018);
  write_cmos_sensor1(0x3C76, 0x0008);
  write_cmos_sensor1(0x3C78, 0x0018);
  write_cmos_sensor1(0x3C7A, 0x0008);
  write_cmos_sensor1(0x3C7C, 0x0018);
  write_cmos_sensor1(0x3C7E, 0x0002);
  write_cmos_sensor1(0x3C80, 0x0003);
  write_cmos_sensor1(0x3C82, 0x0008);
  write_cmos_sensor1(0x3C84, 0x0018);
  write_cmos_sensor1(0x3C86, 0x0008);
  write_cmos_sensor1(0x3C88, 0x0018);
  write_cmos_sensor1(0x3C8A, 0x0008);
  write_cmos_sensor1(0x3C8C, 0x0018);
  write_cmos_sensor1(0x3C8E, 0x0008);
  write_cmos_sensor1(0x3C90, 0x0018);
  write_cmos_sensor1(0x3C92, 0x0200);
  write_cmos_sensor1(0x3C94, 0x0200);
  write_cmos_sensor1(0x3C96, 0x0002);
  write_cmos_sensor1(0x3C98, 0x0003);
  write_cmos_sensor1(0x3C9A, 0x0014);
  write_cmos_sensor1(0x3C9C, 0x0040);
  write_cmos_sensor1(0x3C9E, 0x0014);
  write_cmos_sensor1(0x3CA0, 0x0040);
  write_cmos_sensor1(0x3CA2, 0x0014);
  write_cmos_sensor1(0x3CA4, 0x0040);
  write_cmos_sensor1(0x3CA6, 0x0014);
  write_cmos_sensor1(0x3CA8, 0x0040);
  write_cmos_sensor1(0x3CAA, 0x0002);
  write_cmos_sensor1(0x3CAC, 0x0003);
  write_cmos_sensor1(0x3CAE, 0x0014);
  write_cmos_sensor1(0x3CB0, 0x0040);
  write_cmos_sensor1(0x3CB2, 0x0014);
  write_cmos_sensor1(0x3CB4, 0x0040);
  write_cmos_sensor1(0x3CB6, 0x0014);
  write_cmos_sensor1(0x3CB8, 0x0040);
  write_cmos_sensor1(0x3CBA, 0x0014);
  write_cmos_sensor1(0x3CBC, 0x0040);
  write_cmos_sensor1(0x3CBE, 0x0200);
  write_cmos_sensor1(0x3CC0, 0x0200);
  write_cmos_sensor1(0x3CC2, 0x0002);
  write_cmos_sensor1(0x3CC4, 0x0003);
  write_cmos_sensor1(0x3CC6, 0x0008);
  write_cmos_sensor1(0x3CC8, 0x0018);
  write_cmos_sensor1(0x3CCA, 0x0008);
  write_cmos_sensor1(0x3CCC, 0x0018);
  write_cmos_sensor1(0x3CCE, 0x0008);
  write_cmos_sensor1(0x3CD0, 0x0018);
  write_cmos_sensor1(0x3CD2, 0x0008);
  write_cmos_sensor1(0x3CD4, 0x0018);
  write_cmos_sensor1(0x3CD6, 0x0002);
  write_cmos_sensor1(0x3CD8, 0x0003);
  write_cmos_sensor1(0x3CDA, 0x0008);
  write_cmos_sensor1(0x3CDC, 0x0018);
  write_cmos_sensor1(0x3CDE, 0x0008);
  write_cmos_sensor1(0x3CE0, 0x0018);
  write_cmos_sensor1(0x3CE2, 0x0008);
  write_cmos_sensor1(0x3CE4, 0x0018);
  write_cmos_sensor1(0x3CE6, 0x0008);
  write_cmos_sensor1(0x3CE8, 0x0018);
  write_cmos_sensor1(0x3CEA, 0x0200);
  write_cmos_sensor1(0x3CEC, 0x0200);
  write_cmos_sensor1(0x3CEE, 0x0002);
  write_cmos_sensor1(0x3CF0, 0x0003);
  write_cmos_sensor1(0x3CF2, 0x0014);
  write_cmos_sensor1(0x3CF4, 0x0040);
  write_cmos_sensor1(0x3CF6, 0x0014);
  write_cmos_sensor1(0x3CF8, 0x0040);
  write_cmos_sensor1(0x3CFA, 0x0014);
  write_cmos_sensor1(0x3CFC, 0x0040);
  write_cmos_sensor1(0x3CFE, 0x0014);
  write_cmos_sensor1(0x3D00, 0x0040);
  write_cmos_sensor1(0x3D02, 0x0002);
  write_cmos_sensor1(0x3D04, 0x0003);
  write_cmos_sensor1(0x3D06, 0x0014);
  write_cmos_sensor1(0x3D08, 0x0040);
  write_cmos_sensor1(0x3D0A, 0x0014);
  write_cmos_sensor1(0x3D0C, 0x0040);
  write_cmos_sensor1(0x3D0E, 0x0014);
  write_cmos_sensor1(0x3D10, 0x0040);
  write_cmos_sensor1(0x3D12, 0x0014);
  write_cmos_sensor1(0x3D14, 0x0040);
  write_cmos_sensor1(0x3D16, 0x0200);
  write_cmos_sensor1(0x3D18, 0x0200);
  write_cmos_sensor1(0x3D1A, 0x0002);
  write_cmos_sensor1(0x3D1C, 0x0003);
  write_cmos_sensor1(0x3D1E, 0x0008);
  write_cmos_sensor1(0x3D20, 0x0018);
  write_cmos_sensor1(0x3D22, 0x0008);
  write_cmos_sensor1(0x3D24, 0x0018);
  write_cmos_sensor1(0x3D26, 0x0008);
  write_cmos_sensor1(0x3D28, 0x0018);
  write_cmos_sensor1(0x3D2A, 0x0008);
  write_cmos_sensor1(0x3D2C, 0x0018);
  write_cmos_sensor1(0x3D2E, 0x0002);
  write_cmos_sensor1(0x3D30, 0x0003);
  write_cmos_sensor1(0x3D32, 0x0008);
  write_cmos_sensor1(0x3D34, 0x0018);
  write_cmos_sensor1(0x3D36, 0x0008);
  write_cmos_sensor1(0x3D38, 0x0018);
  write_cmos_sensor1(0x3D3A, 0x0008);
  write_cmos_sensor1(0x3D3C, 0x0018);
  write_cmos_sensor1(0x3D3E, 0x0008);
  write_cmos_sensor1(0x3D40, 0x0018);
  write_cmos_sensor1(0x3D42, 0x0200);
  write_cmos_sensor1(0x3D44, 0x0200);
  write_cmos_sensor1(0x3D46, 0x0002);
  write_cmos_sensor1(0x3D48, 0x0003);
  write_cmos_sensor1(0x3D4A, 0x0014);
  write_cmos_sensor1(0x3D4C, 0x0040);
  write_cmos_sensor1(0x3D4E, 0x0014);
  write_cmos_sensor1(0x3D50, 0x0040);
  write_cmos_sensor1(0x3D52, 0x0014);
  write_cmos_sensor1(0x3D54, 0x0040);
  write_cmos_sensor1(0x3D56, 0x0014);
  write_cmos_sensor1(0x3D58, 0x0040);
  write_cmos_sensor1(0x3D5A, 0x0002);
  write_cmos_sensor1(0x3D5C, 0x0003);
  write_cmos_sensor1(0x3D5E, 0x0014);
  write_cmos_sensor1(0x3D60, 0x0040);
  write_cmos_sensor1(0x3D62, 0x0014);
  write_cmos_sensor1(0x3D64, 0x0040);
  write_cmos_sensor1(0x3D66, 0x0014);
  write_cmos_sensor1(0x3D68, 0x0040);
  write_cmos_sensor1(0x3D6A, 0x0014);
  write_cmos_sensor1(0x3D6C, 0x0040);
  write_cmos_sensor1(0x3D6E, 0x0200);
  write_cmos_sensor1(0x3D70, 0x0200);
  write_cmos_sensor1(0x3D72, 0x0002);
  write_cmos_sensor1(0x3D74, 0x0003);
  write_cmos_sensor1(0x3D76, 0x0008);
  write_cmos_sensor1(0x3D78, 0x0018);
  write_cmos_sensor1(0x3D7A, 0x0008);
  write_cmos_sensor1(0x3D7C, 0x0018);
  write_cmos_sensor1(0x3D7E, 0x0008);
  write_cmos_sensor1(0x3D80, 0x0018);
  write_cmos_sensor1(0x3D82, 0x0008);
  write_cmos_sensor1(0x3D84, 0x0018);
  write_cmos_sensor1(0x3D86, 0x0002);
  write_cmos_sensor1(0x3D88, 0x0003);
  write_cmos_sensor1(0x3D8A, 0x0008);
  write_cmos_sensor1(0x3D8C, 0x0018);
  write_cmos_sensor1(0x3D8E, 0x0008);
  write_cmos_sensor1(0x3D90, 0x0018);
  write_cmos_sensor1(0x3D92, 0x0008);
  write_cmos_sensor1(0x3D94, 0x0018);
  write_cmos_sensor1(0x3D96, 0x0008);
  write_cmos_sensor1(0x3D98, 0x0018);
  write_cmos_sensor1(0x3D9A, 0x0200);
  write_cmos_sensor1(0x3D9C, 0x0200);
  write_cmos_sensor1(0x3D9E, 0x0F00);
  write_cmos_sensor1(0x3DA0, 0x4B00);
  write_cmos_sensor1(0x3DA2, 0x8700);
  write_cmos_sensor1(0x3DA4, 0xC300);
  write_cmos_sensor1(0x3DA6, 0xFF00);
  write_cmos_sensor1(0x3DA8, 0x0032);
  write_cmos_sensor(0x3DAA, 0x42);
  write_cmos_sensor(0x3DAB, 0xFF);
  write_cmos_sensor(0x3DAC, 0x08);
  write_cmos_sensor1(0x3DAE, 0x0001);
  write_cmos_sensor(0x3DB0, 0x00);
  write_cmos_sensor(0x3DB1, 0x08);
  write_cmos_sensor1(0x3DB2, 0x00FF);
  write_cmos_sensor(0x3DB4, 0x00);
  write_cmos_sensor(0x3DB5, 0x08);
  write_cmos_sensor1(0x3DB6, 0x0100);
  write_cmos_sensor(0x3DB8, 0x01);
  write_cmos_sensor1(0x3DBA, 0x0F00);
}    /*    sensor_init  */
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor1(0x034C, 0x0838);
  write_cmos_sensor1(0x034E, 0x0618);
  write_cmos_sensor(0x0114, 0x03);
  write_cmos_sensor1(0x0344, 0x0004);
  write_cmos_sensor1(0x0346, 0x0004);
  write_cmos_sensor1(0x0348, 0x1075);
  write_cmos_sensor1(0x034A, 0x0C33);
  write_cmos_sensor1(0x3010, 0x0001);
...
{	
  ...
  write_cmos_sensor1(0x034C, 0x1070);
  write_cmos_sensor1(0x034E, 0x0C30);
  write_cmos_sensor(0x0114, 0x03);
  write_cmos_sensor1(0x0344, 0x0004);
  write_cmos_sensor1(0x0346, 0x0004);
  write_cmos_sensor1(0x0348, 0x1073);
  write_cmos_sensor1(0x034A, 0x0C35);
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            sensor_id = return_sensor_id();
            if (sensor_id == imgsensor_info.sensor_id) {
                printk("s5k3l2 open i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
                break;
            }
            printk("s5k3l2 open  Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        if (sensor_id == imgsensor_info.sensor_id)
