...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.checksum_value = 0xf958490a,       //0x6d01485c // Auto Test Mode ??ии?..
	.pre = {
	...
	.max_frame_length = 0x7FFF,
		...
		.i2c_addr_table = {0x40, 0x20,0xff},
		.i2c_speed = 400,
};


static struct imgsensor_struct imgsensor = {
#ifdef CONFIG_HI1333_MIRROR_HV
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] ={
	...
	{ 4240, 3124,   0,   0, 4240, 3124,	 2120, 1562,  16, 2, 2104, 1560, 0, 0, 2104, 1560},		// hight speed video (640 x 480)
 	{ 4240, 3124,   0,   0, 4240, 3124,	 2120, 1562,  16, 2, 2104, 1560, 0, 0, 2104, 1560},       // slim video (1280 x 720)
};
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    write_cmos_sensor1D(0x0077,reg_gain);
...
//write_cmos_sensor(0x000e, 0x0100); //image orient//mirror
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id = ((read_cmos_sensor(0x0F17) << 8) | read_cmos_sensor(0x0F16));
				...
				printk("get_imgsensor_id Read sensor id fail, id: 0x%x 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
				retry--;
			} while(retry > 0);
			i++;
			retry = 2;
