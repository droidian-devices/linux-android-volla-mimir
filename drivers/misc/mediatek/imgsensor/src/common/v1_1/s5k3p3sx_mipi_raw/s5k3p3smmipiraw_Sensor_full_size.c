...
#if IS_ENABLED(CONFIG_S5K3P3SX_MIRROR_HV) //Leo 20230324
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
 ...
 { 4608, 3456,	0,	0, 4608, 3456, 2304,  1728,  594,  429, 1152,   870,	0,	0, 1152,  870}, //hight speed video
 { 4608, 3456,	0,	0, 4608, 3456, 2304,  1728, 0000, 0000, 2304,  1728,	0,	0, 2304, 1728}
 };// slim video
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id ==imgsensor_info.sensor_id) {
				printk("s5k3p3sx i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);

				return ERROR_NONE;
			}
			printk("s5k3p3sx  Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		retry = 5;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 3000000;
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			read_3P3_eeprom_v1((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;			
