...
#define PFX "s5k3l8mipiraw_Sensor"
/*===FEATURE SWITH===*/
...
{
	{ 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104}, /* Preview */
	...
	{ 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104}, /*hight speed video*/
	{ 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},/*slim video */
 { 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},// Custom1 (defaultuse preview) 
 { 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},// Custom2 
 { 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},// Custom3 
 { 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},// Custom4 
 { 4208, 3120, 0, 0, 4208, 3120, 4208, 3120, 0,	0, 4208, 3120, 8, 8, 4192, 3104},// Custom5 
};
...
#if IS_ENABLED(CONFIG_MID_CSCI_SUPPORT) //Leo 20220909
    if (csci_exist("camera.mirror.support.s5k3l8")) {
        if (csci_integer("camera.mirror.support.s5k3l8", 0) > 0) {
 ...
 //    spin_unlock(&imgsensor_drv_lock);
	switch (image_mirror) {
		...
		case IMAGE_HV_MIRROR:
			write_cmos_sensor(0x0101,0X0303); //GB
			break;
		default:
...
#endif
				printk("cam s5k3l8mipiraw_Sensor i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);	
                return ERROR_NONE;
            }
			printk("cam s5k3l8mipiraw_Sensor Read sensor id fail, i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id,*sensor_id,imgsensor_info.sensor_id);	
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
#if IS_ENABLED(CONFIG_MID_CSCI_SUPPORT) //Leo 20220909
    if (csci_exist("camera.output.dataformat.s5k3l8")) {
        sensor_info->SensorOutputDataFormat = csci_integer("camera.output.dataformat.s5k3l8", 0);
    }
#endif
