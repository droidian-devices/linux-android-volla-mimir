...
#include "aw35615csr/aw35615_global.h"
#endif
...
#if IS_ENABLED(CONFIG_AW35615_PD)
int aw35615_chip_id=0;
int AW35615_ID = 0x344f;
int aw35615_getchip_id(void){
	pr_err("AWINIC  %s 0x%x \n", __func__,aw35615_chip_id);
	return aw35615_chip_id;
}

int aw35615_setchip_id(int chip_id){
	pr_err("AWINIC  %s 0x%x \n", __func__,chip_id);
	aw35615_chip_id=chip_id;
	return aw35615_chip_id;
}
EXPORT_SYMBOL(aw35615_setchip_id);
...
#if IS_ENABLED(CONFIG_AW35615_PD)
	int ret;
	if (aw35615_getchip_id() == AW35615_ID) {
...
#if IS_ENABLED(CONFIG_AW35615_PD) || IS_ENABLED(CONFIG_TCPC_HUSB311) //jnier modfy 20240305
	int ret;
#endif
#if IS_ENABLED(CONFIG_AW35615_PD)
	if (aw35615_getchip_id() == AW35615_ID) {
