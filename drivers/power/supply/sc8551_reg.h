...
#define SC8551_AC_OVP_BASE				11000
#define SC8551_AC_OVP_LSB				1000
#define SC8551_AC_OVP_6P5V				6500
...
#define SC8551_VBUS_INRANGE_DIS_MASK        0x40
#define SC8551_VBUS_INRANGE_DIS_SHIFT       6
#define SC8551_VBUS_INRANGE_ENABLE          0
#define SC8551_VBUS_INRANGE_DISABLE         1

#define SC8551_REG_36						0x36
#define SC8551_OVPGATE_DIS_MASK             0x08
#define SC8551_OVPGATE_DIS_SHIFT            3
