 ...
 * 1:enable(default),0:disable
*/
#if defined(CONFIG_TOUCHSCREEN_FTS_PEN)
#define FTS_PEN_EN                              1
#else
#define FTS_PEN_EN                              0
#endif
 ...
 * default: disable
 */
#if defined(CONFIG_TOUCHSCREEN_FTS_GESTURE) //Leo 20231110
 ...
 * default: disable
 */
#if defined(CONFIG_TOUCHSCREEN_FTS_ESDCHECK) //Leo 20231110
 ...
 */
#if defined(M100TBR210_YPD_891) || defined(M100TBR210_YPD_900_WIFI) || defined(M100TBR210_YPD_1125)
#define FTS_UPGRADE_FW_FILE                     "include/firmware/FT8201AB_V01_D00_HSD_10P51_MODULE_LONG_V_MODE_20221029_app.i"
#else
