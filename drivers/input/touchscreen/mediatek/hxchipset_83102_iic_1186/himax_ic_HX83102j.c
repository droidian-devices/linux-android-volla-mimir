...
void hx83102j_init(void)
{
	...
	hx_s_core_fp._switch_mode = himax_switch_mode_inspection;
	hx_s_core_fp._switch_data_type = himax_switch_data_type;
	hx_s_core_fp._check_mode = himax_check_mode;
	hx_s_core_fp._wait_sorting_mode = himax_wait_sorting_mode;
#endif
