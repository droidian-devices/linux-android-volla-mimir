...
#define HIMAX_DRIVER_VER "2.1.0.20_#5781_P12_01"
...
//#define XY_SWITCH_FLAG
#define X_REVERT_FLAG
#define Y_REVERT_FLAG
...
enum fix_touch_info {
	...
	FIX_HX_BT_NUM = 0,
	FIX_HX_MAX_PT = 10,
#if defined(CONFIG_TOUCHSCREEN_HIMAX_INT_LEVEL) //Leo 20240425
	FIX_HX_INT_IS_EDGE = false,
#else
	FIX_HX_INT_IS_EDGE = true,
#endif
#if defined(CONFIG_TOUCHSCREEN_HIMAX_PEN_SUPPORT) //Leo 20240425
